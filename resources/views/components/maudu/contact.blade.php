            ...
            <div class="col-lg-5">
                <div class="contact-info-wrap">
                    ...
                    <div class="contact-info-item mb-4">
                        ...
                        <div class="contact-text">
                            <h5>Telepon</h5>
                            <p><a href="tel:{{ theme_config('phone') }}">{{ theme_config('phone') }}</a></p>
                            @if (theme_config('phone_secondary'))
                                <p><a
                                        href="tel:{{ theme_config('phone_secondary') }}">{{ theme_config('phone_secondary') }}</a>
                                </p>
                            @endif
                        </div>
                    </div>
                    <div class="contact-info-item mb-4">
                        ...
                        <div class="contact-text">
                            <h5>Email</h5>
                            <p><a href="mailto:{{ theme_config('email') }}">{{ theme_config('email') }}</a></p>
                        </div>
                    </div>
                    <div class="contact-info-item mb-4">
                        <div class="contact-icon me-3">
                        ...
                        <div class="contact-text">
                            ...
                            <p>{{ theme_config('working_hours.days', 'Sabtu - Kamis') }}<br>
                                {{ theme_config('working_hours.hours', '08:00 - 16:00 WIB') }}</p>
                        </div>
                    </div>
