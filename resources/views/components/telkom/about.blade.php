            ...
            <div class="col-lg-5 pr-65 md-pr-15 md-mb-50">
                <div class="about-intro">
                    ...
                    <div class="headmaster-photo mb-30">
                        ...
                        @endphp
                        <img src="{{ $hpUrl }}" alt="{{ $siteSettings['headmaster_name'] ?? 'Kepala Sekolah' }}"
                    ...
                    <div class="sec-title mb-40 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                        ...
                        <h6 class="title mb-21 white-color">KEPALA SEKOLAH <br>{{ strtoupper($siteSettings['headmaster_school_name'] ?? 'SMK TELEKOMUNIKASI DARUL ULUM JOMBANG') }}</h6>
                    ...
                    <div class="btn-part wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                        <a class="readon2" href="{{ $siteSettings['about_button_url'] ?? '#' }}">{{ $siteSettings['about_button_text'] ?: 'Detail' }}</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row rs-counter couter-area mb-40">
                    <div class="col-md-4">
                        <div class="counter-item one">
                            <h2 class="number rs-count kplus">{{ $siteSettings['counter1_number'] ?? ($siswaCount > 0 ? $siswaCount : '500') }}</h2>
                    ...
                    <div class="col-md-6 sm-mb-30">
                        <div class="image-grid">
                            @if(!empty($siteSettings['about_image_1']))
                                ...
                                @endphp
                                <img src="{{ $ai1Url }}" alt="Tentang Kami 1">
                            @else
                    ...
                    <div class="col-md-6">
                        <div class="image-grid">
                            @if(!empty($siteSettings['about_image_2']))
                                ...
                                @endphp
                                <img src="{{ $ai2Url }}" alt="Tentang Kami 2">
                            @else
