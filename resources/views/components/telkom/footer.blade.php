            ...
            <div class="row y-middle">
                    ...
                    <div class="footer-logo text-center text-md-start">
                        <a href="{{ route('landing') }}">
                            @if(!empty($siteSettings['logo']))
                                <img src="{{ Storage::url($siteSettings['logo']) }}" alt="{{ $siteSettings['site_name'] ?? 'Logo' }}" style="max-height: 50px;">
                            @else
                                <img src="{{ asset('assets_telkom/assets/images/logo.png') }}" alt="Logo" style="max-height: 50px;">
                            @endif
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 mb-3 mb-md-0">
                    <div class="copyright text-center">
                        <p>{!! $siteSettings['footer_text'] ?? '&copy; ' . date('Y') . ' All Rights Reserved. Developed By <a href="https://www.tiktok.com/@kritis.tv" target="_blank">Kritis.TV</a>' !!}</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 text-center text-md-end">
                    <ul class="footer-social">
                        <li><a href="{{ $siteSettings['social_facebook'] ?? 'https://www.facebook.com/smktelkomdarululum' }}" target="_blank" rel="noopener" title="Facebook"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="{{ $siteSettings['social_instagram'] ?? 'https://www.instagram.com/smktelkomdarululum' }}" target="_blank" rel="noopener" title="Instagram"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="{{ $siteSettings['social_youtube'] ?? 'https://www.youtube.com/@smktelkomdarululum' }}" target="_blank" rel="noopener" title="YouTube"><i class="fa fa-youtube"></i></a></li>
                        <li><a href="{{ $siteSettings['social_whatsapp'] ?? 'https://wa.me/6285649400339' }}" target="_blank" rel="noopener" title="WhatsApp"><i class="fa fa-whatsapp"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
