                    ...
                    <div class="mb-8">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div class="flex items-center space-x-3">
                                <a href="{{ route('admin.themes.compare') }}"
                                ...
                                <a href="{{ route('admin.themes.analytics') }}"
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">
                                    <strong>Tema Aktif:</strong> <span
                                        class="font-bold">{{ strtoupper($activeTheme ?? config('app.default_theme', 'telkom')) }}</span>
                            ...
                            <div
                                ...
                                <div class="p-6 border-t">
                                    ...
                                    <div class="flex items-center space-x-3 mb-4">
                                        ...
                                        <a href="{{ route('admin.themes.export', $themeKey) }}"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <a href="{{ route('admin.themes.import', $themeKey) }}"
                                        ...
                                        <!-- P3-6.2: Clone Button -->
                                        <button
                                            onclick="cloneTheme('{{ $themeKey }}', '{{ $themeInfo['name'] }}')"
