        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div>
                                ...
                                <p class="text-gray-600 mt-2">
                                    ...
                                    <strong>{{ $themes[$theme]['name'] ?? $theme }}</strong>
                                </p>
                            </div>
                    ...
                    <!-- Import Form -->
                    <form action="{{ route('admin.themes.import-process', $theme) }}" method="POST"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-3">
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition
                                    {{ old('import_mode', 'merge') === 'merge' ? 'border-blue-400 bg-blue-50' : 'border-gray-200' }}">
                                    <input type="radio" name="import_mode" value="merge"
                                        {{ old('import_mode', 'merge') === 'merge' ? 'checked' : '' }}
                                ...
                                <label class="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition
                                    {{ old('import_mode') === 'replace' ? 'border-red-400 bg-red-50' : 'border-gray-200' }}">
                                    <input type="radio" name="import_mode" value="replace"
                                        {{ old('import_mode') === 'replace' ? 'checked' : '' }}
