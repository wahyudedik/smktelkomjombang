                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-purple-600">
                                        {{ __('common.total_ekstrakurikuler') }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <a href="{{ route('admin.settings.data-management') }}"
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-medium text-gray-900">{{ __('common.data_management') }}
                                    </h3>
                        ...
                        <a href="{{ route('admin.settings.landing-page') }}"
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-sm text-gray-600">{{ __('common.manage_landing_page_description') }}
                                    </p>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('profile.edit') }}"
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-medium text-gray-900">{{ __('common.profile_settings') }}
                                    </h3>
