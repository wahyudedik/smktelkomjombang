    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ str_replace(':title', $page->title, __('common.edit_page')) }}
            </h2>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="status" id="status"
                                            ...
                                            required>
                                            <option value="draft"
                                                {{ old('status', $page->status) == 'draft' ? 'selected' : '' }}>{{ __('common.draft') }}
                                            </option>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if ($page->featured_image)
                                            <div class="mb-2">
                                                ...
                                                <p class="text-xs text-gray-500 mt-1">{{ __('common.current_image') }}</p>
                                            </div>
                                        @endif
                                    ...
                                    <div id="menu-settings" class="space-y-4"
                                        ...
                                        <div>
                                            <label for="menu_title"
                                                class="block text-sm font-medium text-gray-700 mb-1">{{ __('common.menu_title') }}</label>
                                        ...
                                        <div>
                                            <label for="menu_icon"
                                                class="block text-sm font-medium text-gray-700 mb-1">{{ __('common.menu_icon') }}</label>
                                        ...
                                        <div>
                                            <label for="menu_url"
                                                class="block text-sm font-medium text-gray-700 mb-1">{{ __('common.custom_url') }}</label>
