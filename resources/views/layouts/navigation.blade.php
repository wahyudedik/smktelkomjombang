            ...
            <div class="hidden md:flex items-center space-x-6">
                @auth
                    <a href="{{ route('admin.dashboard') }}"
                        class="text-sm font-medium {{ request()->routeIs('admin.dashboard') ? 'text-blue-600' : 'text-slate-600 hover:text-slate-900 dark:text-dark-300 dark:hover:text-white' }} transition-colors">
                        {{ __('common.dashboard') }}
                    </a>
                ...
                <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    @if ($showEServices)
                        <div class="px-3 py-2">
                            ...
                            <div class="space-y-1 ml-2">
                                @if (Auth::user()->hasAnyRole(['admin', 'superadmin', 'osis']) ||
                                        Auth::user()->can('osis.view') ||
                                        Auth::user()->can('osis.read'))
                                    <a href="{{ route('admin.osis.index') }}"
                                        class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
