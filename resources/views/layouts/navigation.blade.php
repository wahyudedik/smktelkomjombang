                    ...
                    @if ($showContent)
                        <div class="relative group">
                            ...
                            <div
                                class="absolute top-full left-0 mt-1 w-48 bg-white rounded-lg shadow-lg border border-slate-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                                <div class="py-2">
                                    @if (Auth::user()->hasAnyRole(['admin', 'superadmin']) || Auth::user()->can('settings.manage') || Auth::user()->can('settings.view'))
                ...
                <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    @if ($showAcademic)
                        <div class="px-3 py-2">
                            ...
                            <div class="space-y-1 ml-2">
                                @if (Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin']) || Auth::user()->can('guru.view') || Auth::user()->can('guru.read'))
                                    <a href="{{ route('admin.guru.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-chalkboard-teacher mr-2"></i>Guru Management
                                    </a>
                                @endif
                                @if (Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin']) || Auth::user()->can('siswa.view') || Auth::user()->can('siswa.read'))
                                    <a href="{{ route('admin.siswa.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-user-graduate mr-2"></i>Siswa Management
                                    </a>
                                @endif
                                @if (Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin']) || Auth::user()->can('jadwal.view') || Auth::user()->can('jadwal.read'))
                                    <a href="{{ route('admin.jadwal-pelajaran.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-calendar-alt mr-2"></i>Jadwal Pelajaran
                                    </a>
                                @endif
                                @if (Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin']) || Auth::user()->can('attendance.view'))
                                    <a href="{{ route('admin.absensi.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-user-check mr-2"></i>Absensi
                                    </a>
                                @endif
                                @if (Auth::user()->hasAnyRole(['sarpras', 'admin', 'superadmin']) || Auth::user()->can('sarpras.view') || Auth::user()->can('sarpras.read'))
                                    <a href="{{ route('admin.sarpras.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-building mr-2"></i>Sarpras Management
                                    </a>
                                @endif
                            </div>
                    ...
                    @if ($showEServices)
                        <div class="px-3 py-2">
                            ...
                            <div class="space-y-1 ml-2">
                                @if (Auth::user()->hasAnyRole(['admin', 'superadmin', 'osis']) || Auth::user()->can('osis.view') || Auth::user()->can('osis.read'))
                                    <a href="{{ route('admin.osis.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-vote-yea mr-2"></i>E-OSIS Voting
                                    </a>
                                @endif
                                ...
                                @endif
                                @if (Auth::user()->hasAnyRole(['admin', 'superadmin', 'guru', 'sarpras']) || Auth::user()->can('surat.view'))
                                    <div class="border-t border-slate-100 my-1"></div>
                                    <a href="{{ route('admin.letters.out.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-paper-plane mr-2"></i>Surat Keluar
                                    </a>
                    ...
                    @if (Auth::user()->hasRole('siswa'))
                        <div class="px-3 py-2">
                            ...
                            <div class="space-y-1 ml-2">
                                @if (Auth::user()->hasRole('siswa') || Auth::user()->can('osis.vote'))
                                    <a href="{{ route('admin.osis.voting') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-vote-yea mr-2"></i>OSIS Voting
                                    </a>
                                @endif
                                @if (Auth::user()->hasRole('siswa') || Auth::user()->can('osis.results'))
                                    <a href="{{ route('admin.osis.results') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-chart-bar mr-2"></i>Voting Results
                                    </a>
                                @endif
                                @if (Auth::user()->hasRole('siswa') || Auth::user()->can('jadwal.read'))
                                    <a href="{{ route('admin.jadwal-pelajaran.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-calendar-alt mr-2"></i>Jadwal Pelajaran
                                    </a>
                                @endif
                    ...
                    @if ($showContent)
                        <div class="px-3 py-2">
                            ...
                            <div class="space-y-1 ml-2">
                                @if (Auth::user()->hasAnyRole(['admin', 'superadmin']) || Auth::user()->can('settings.manage') || Auth::user()->can('settings.view'))
                                    <a href="{{ route('landing') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-globe mr-2"></i>Landing Page
                                    </a>
                                @endif
                                @if (Auth::user()->hasAnyRole(['admin', 'superadmin']) || Auth::user()->can('pages.view'))
                                    <a href="{{ route('admin.pages.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-file-alt mr-2"></i>Page Management
                                    </a>
                                @endif
                                @if (Auth::user()->hasAnyRole(['admin', 'superadmin']) || Auth::user()->can('events.view'))
                                    <a href="{{ route('admin.events.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-calendar-alt mr-2"></i>Events / Kegiatan
                                    </a>
                                @endif
                                @if (Auth::user()->hasAnyRole(['admin', 'superadmin']) || Auth::user()->can('berita.view'))
                                    <a href="{{ route('admin.berita.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-newspaper mr-2"></i>Berita / News
                                    </a>
                                @endif
                                @if (Auth::user()->hasRole('superadmin'))
                                    <a href="{{ route('admin.superadmin.instagram-settings') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fab fa-instagram mr-2"></i>{{ __('common.instagram_settings') }}
                                    </a>
                                @endif
                            </div>
                        ...
                        <div class="px-3 py-2">
                            ...
                            <div class="space-y-1 ml-2">
                                @if (Auth::user()->hasAnyRole(['superadmin', 'admin']))
                                    <a href="{{ route('admin.superadmin.users') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-users-cog mr-2"></i>User Management
                                    </a>
                                @elseif (Auth::user()->canAny(['users.view','users.create','users.edit','users.delete']))
                                    <a href="{{ route('admin.user-management.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-users mr-2"></i>User Management
                                    </a>
                                @endif
                                @if (Auth::user()->hasRole('superadmin'))
                                    <a href="{{ route('admin.role-permissions.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-shield-alt mr-2"></i>Role & Permissions
                                    </a>
                                @endif
                                @if (Auth::user()->hasRole('superadmin'))
                                    @can('viewAny', App\Models\Permission::class)
                                        <a href="{{ route('admin.permissions.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                            <i class="fas fa-key mr-2"></i>Permission Management
                                        </a>
                                    @endcan
                                @endif
                                @if (Auth::user()->hasRole('superadmin'))
                                    <a href="{{ route('admin.audit-logs.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-history mr-2"></i>Audit Logs
                                    </a>
                                @endif
                                @can('viewAnalytics', App\Models\User::class)
                                    <a href="{{ route('admin.analytics') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-chart-line mr-2"></i>{{ __('common.analytics_dashboard') }}
                                    </a>
                                @endcan
                                @can('viewSystemHealth', App\Models\User::class)
                                    <a href="{{ route('admin.system.health') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-heartbeat mr-2"></i>{{ __('common.system_health') }}
                                    </a>
                                @endcan
                                @can('viewNotifications', App\Models\User::class)
                                ...
                                @canany(['testimonials.view', 'testimonials.create', 'testimonials.edit', 'testimonials.delete'])
                                    <a href="{{ route('admin.testimonials.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-comments mr-2"></i>{{ __('common.manage_testimonials') }}
                                    </a>
                                @endcanany
                                @can('testimonial-links.view')
                                    <a href="{{ route('admin.testimonial-links.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                        <i class="fas fa-link mr-2"></i>{{ __('common.testimonial_links') }}
                                    </a>
                                @endcan
                                <a href="{{ route('admin.settings.index') }}" class="block px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg">
                                    <i class="fas fa-cog mr-2"></i>{{ __('common.system_settings') }}
                                </a>
                            </div>
                        </div>
