    ...
    <x-slot name="header">
        <div class="bg-white dark:bg-dark-800 border-b border-slate-200 dark:border-dark-700">
            <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                {{-- Breadcrumb --}}
                <x-admin.breadcrumb :title="Auth::user()->hasRole('superadmin') ? __('common.superadmin_dashboard') : (Auth::user()->hasRole('admin') ? __('common.admin_dashboard') : __('common.dashboard'))" :items="[
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-2">
                    <div>
                        <p class="text-slate-600 dark:text-dark-300">{{ __('common.welcome_back') }}, {{ Auth::user()->name }}!</p>
                    </div>
