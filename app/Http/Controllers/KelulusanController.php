...
class KelulusanController extends Controller
{
    ...
    public function downloadTemplate()
    {
        ...
        // tahun_ajaran supports both "2025/2026" (string) and "2025" (integer) format
        $sampleData = [
            [
            ...
            [
                ...
                'jurusan_kuliah' => '',
                'jabatan_kerja' => 'Staff Desain',
                'no_hp'         => '08987654321',
                'no_wa'         => '08987654321',
                'alamat'        => 'Jl. Contoh No. 456, Jombang',
                'prestasi'      => '',
                'catatan'       => '',
                'tanggal_lulus' => '2026-05-04',
            ],
            ...
            [
                ...
                'alamat'        => '',
                'prestasi'      => '',
                'catatan'       => 'Mengulang tahun ajaran berikutnya',
                'tanggal_lulus' => '',
            ],
        ];
    ...
    {
        return view(theme_view('public.elulus.check'));
    }
    ...
    public function publicProcessCheck(Request $request)
    {
        ...
        return view(theme_view('public.elulus.result'), compact('kelulusan'));
    }
