<?php $__env->startSection('content'); ?>
    ...
    <div class="site-breadcrumb" style="background: url(<?php echo e(asset('assets/img/breadcrumb/01.jpg')); ?>)">
        <div class="container">
            <h2 class="breadcrumb-title"><?php echo e(__('common.event_maudu')); ?></h2>
            <ul class="breadcrumb-menu">
                <li><a href="/"><?php echo e(__('common.home')); ?></a></li>
                <li class="active"><?php echo e(__('common.kegiatan')); ?></li>
            </ul>
        </div>
    </div>
    <!-- breadcrumb end -->
    ...
    <div class="campus-life pt-120 pb-80">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="site-heading text-center mb-5">
                        <h2 class="site-title"><?php echo e(__('common.gallery_latest_activities')); ?></h2>
                        <p class="site-subtitle"><?php echo e(__('common.update_kegiatan_instagram')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div id="loadingState" class="text-center py-5" style="display: none;">
                ...
                <p class="mt-3"><?php echo e(__('common.loading_instagram_data')); ?></p>
            </div>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-12">
                        <div class="text-center py-5">
                            ...
                            <h4 class="text-muted"><?php echo e(__('common.belum_ada_kegiatan')); ?></h4>
                            <p class="text-muted"><?php echo e(__('common.kegiatan_akan_muncul')); ?></p>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (refreshBtn) {
                    refreshBtn.addEventListener('click', function() {
                        ...
                        refreshText.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i><?php echo e(__('common.refreshing')); ?>';
                        ...
                        fetch('/kegiatan/posts', {
                            ...
                            .then(result => {
                                if (!result.ok) {
                                    showError('<?php echo e(__('common.error')); ?>', '<?php echo e(__('common.data_update_failed')); ?>: Status ' + result.status);
                                    return;
                                }
                                ...
                                if (result.data.success) {
                                    ...
                                    showSuccess('<?php echo e(__('common.success')); ?>', '<?php echo e(__('common.data_update_success')); ?>');
                                    ...
                                    showError('<?php echo e(__('common.error')); ?>', '<?php echo e(__('common.data_update_failed')); ?>: ' + (result.data.message ||
                                        'Unknown error'));
                                }
                            })
                            .catch(error => {
                                console.error('Error:', error);
                                showError('<?php echo e(__('common.error')); ?>', '<?php echo e(__('common.data_update_failed')); ?>: ' + error.message);
                            })
                            .finally(() => {
                                // Reset button state
                                refreshBtn.disabled = false;
                                refreshText.innerHTML = '<i class="fas fa-sync-alt mr-2"></i><?php echo e(__('common.perbarui_data')); ?>';
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\telkom\resources\views\instagram\activities.blade.php ENDPATH**/ ?>