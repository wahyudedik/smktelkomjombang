...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                ...
                <p class="text-slate-600 mt-1">Ubah data izin untuk <?php echo e($excuse->nama); ?></p>
            </div>
            <a href="<?php echo e(route('admin.absensi.excuses.show', $excuse)); ?>" class="btn btn-secondary">Kembali</a>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="<?php echo e(route('admin.absensi.excuses.update', $excuse)); ?>" enctype="multipart/form-data" class="bg-white rounded-xl border border-slate-200 p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="attendance_identity_id" class="mt-1 block w-full rounded-md border-slate-300 text-sm" required>
                        ...
                        <?php $__currentLoopData = $identities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $identity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($identity['id']); ?>" <?php echo e(old('attendance_identity_id', $excuse->attendance_identity_id) == $identity['id'] ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <select name="type" class="mt-1 block w-full rounded-md border-slate-300 text-sm" required>
                        ...
                        <option value="izin" <?php echo e(old('type', $excuse->type) === 'izin' ? 'selected' : ''); ?>>Izin</option>
                        <option value="sakit" <?php echo e(old('type', $excuse->type) === 'sakit' ? 'selected' : ''); ?>>Sakit</option>
                        <option value="cuti" <?php echo e(old('type', $excuse->type) === 'cuti' ? 'selected' : ''); ?>>Cuti</option>
                        <option value="dinas" <?php echo e(old('type', $excuse->type) === 'dinas' ? 'selected' : ''); ?>>Dinas Luar</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="date" value="<?php echo e(old('date', $excuse->date->toDateString())); ?>"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="reason" rows="4" class="mt-1 block w-full rounded-md border-slate-300 text-sm"
                        placeholder="Jelaskan alasan izin/sakit..." required><?php echo e(old('reason', $excuse->reason)); ?></textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <?php if($excuse->attachment_path): ?>
                        <div class="mt-1 mb-2 text-sm text-slate-600">
                            File saat ini: <a href="<?php echo e(Storage::disk('public')->url($excuse->attachment_path)); ?>" target="_blank" class="text-blue-600 hover:underline">Lihat lampiran</a>
                        </div>
                    <?php endif; ?>
            ...
            <div class="mt-6 flex items-center justify-end space-x-3">
                <a href="<?php echo e(route('admin.absensi.excuses.show', $excuse)); ?>" class="btn btn-secondary">Batal</a>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\attendance\excuses\edit.blade.php ENDPATH**/ ?>