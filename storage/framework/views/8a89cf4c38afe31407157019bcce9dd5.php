...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-slate-800 leading-tight">
            <?php echo e(__('Tambah Format Surat')); ?>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="p-6 bg-white shadow sm:rounded-lg space-y-6">
                <form method="POST" action="<?php echo e(route('admin.letters.formats.store')); ?>" class="space-y-6" id="format-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="type" name="type"
                                ...
                                <option value="out" <?php if(old('type') === 'out'): echo 'selected'; endif; ?>>Keluar</option>
                                <option value="in" <?php if(old('type') === 'in'): echo 'selected'; endif; ?>>Masuk</option>
                            </select>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <select id="period_mode" name="period_mode"
                                class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="year" <?php if(old('period_mode') === 'year'): echo 'selected'; endif; ?>>Tahunan</option>
                                <option value="month" <?php if(old('period_mode') === 'month'): echo 'selected'; endif; ?>>Bulanan</option>
                                <option value="all" <?php if(old('period_mode') === 'all'): echo 'selected'; endif; ?>>Tidak Reset</option>
                            </select>
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <select id="counter_scope" name="counter_scope"
                                class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="global" <?php if(old('counter_scope') === 'global'): echo 'selected'; endif; ?>>Global</option>
                                <option value="unit" <?php if(old('counter_scope') === 'unit'): echo 'selected'; endif; ?>>Per Unit</option>
                            </select>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <input id="name" name="name" type="text"
                                class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                value="<?php echo e(old('name')); ?>" required placeholder="Contoh: Surat Keputusan" />
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\admin\letters\formats\create.blade.php ENDPATH**/ ?>