...
<head>
    ...
    <title>Sertifikat Kelulusan - <?php echo e($kelulusan->nama); ?></title>
    <style>
        .certificate-actions {
            position: fixed;
            top: 20px;
    ...
    <div class="certificate-container" id="certificate">
        ...
        <div class="content">
            <div>
                ...
                <?php if($kelulusan->jurusan): ?>
                    <div class="school-jurusan">
                        Jurusan: <?php echo e($kelulusan->jurusan); ?>
                ...
                <div class="student-details">
                    NISN: <?php echo e($kelulusan->nisn); ?>

                    <?php if($kelulusan->nis): ?>
                        | NIS: <?php echo e($kelulusan->nis); ?>

                    <?php endif; ?>
                    | Tahun Ajaran: <?php echo e($kelulusan->tahun_ajaran); ?>
                ...
                <div class="achievement-text">
                    <?php if($kelulusan->status === 'lulus'): ?>
                        ...
                        <?php if($kelulusan->tanggal_lulus): ?>
                            pada tanggal <?php echo e($kelulusan->tanggal_lulus->format('d F Y')); ?>
                ...
                <div class="date-section">
                    <?php if($kelulusan->tanggal_lulus): ?>
                        <?php echo e($kelulusan->tanggal_lulus->format('d F Y')); ?>
...
<?php /**PATH E:\PROJEKU\telkom\resources\views\lulus\certificate.blade.php ENDPATH**/ ?>