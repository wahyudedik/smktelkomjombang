...
<?php $component->withAttributes([]); ?>
    ...
    <script>
        ...
        function searchBarcode(code) {
            ...
            fetch('<?php echo e(route('admin.sarpras.barcode.scan.process')); ?>', {
                    method: 'POST',
                    headers: {
        ...
        function displayResults(data) {
            ...
            const detailUrl = '<?php echo e(route('admin.sarpras.barang.index')); ?>/' + data.id;
        ...
        function printBarcode(id) {
            ...
            const printBase = '<?php echo e(route('admin.sarpras.barcode.generate-all')); ?>';
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\scan-barcode.blade.php ENDPATH**/ ?>