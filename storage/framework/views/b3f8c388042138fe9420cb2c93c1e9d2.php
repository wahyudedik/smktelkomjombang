...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <h1 class="text-2xl font-bold text-slate-900"><?php echo e(__('common.import_osis_voters')); ?></h1>
                <p class="text-slate-600 mt-1"><?php echo e(__('common.import_voters_description')); ?></p>
            </div>
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('admin.osis.pemilih.downloadTemplate')); ?>" class="btn btn-secondary">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl border border-slate-200 p-8">
            ...
            <!-- Instructions -->
            <div class="mb-8">
                <h3 class="text-lg font-semibold text-slate-900 mb-4"><?php echo e(__('common.import_guide')); ?></h3>
            ...
            <!-- Import Form -->
            <form method="POST" action="<?php echo e(route('admin.osis.pemilih.processImport')); ?>" enctype="multipart/form-data"
                class="space-y-6">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\osis\pemilih\import.blade.php ENDPATH**/ ?>