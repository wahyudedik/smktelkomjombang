...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <h1 class="text-2xl font-bold text-slate-900"><?php echo e(__('common.create_new_user')); ?></h1>
                <p class="text-slate-600 mt-1"><?php echo e(__('common.add_user_description')); ?></p>
            </div>
            <a href="<?php echo e(route('admin.superadmin.users')); ?>" class="btn btn-secondary">
                ...
                <?php echo e(__('common.back_to_users')); ?>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="card">
            <div class="card-header">
                <h3 class="text-lg font-semibold text-slate-900"><?php echo e(__('common.user_information')); ?></h3>
            </div>
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('admin.superadmin.users.store')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input id="password_confirmation" type="password" name="password_confirmation" required
                            class="form-input" placeholder="<?php echo e(__('common.confirm_password')); ?>">
                    </div>

                    <!-- Roles -->
                    <div>
                        <label class="form-label"><?php echo e(__('common.assign_roles')); ?></label>
                        <div class="space-y-2">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-end space-x-4">
                        <a href="<?php echo e(route('admin.superadmin.users')); ?>" class="btn btn-secondary"><?php echo e(__('common.cancel')); ?></a>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\superadmin\users\create.blade.php ENDPATH**/ ?>