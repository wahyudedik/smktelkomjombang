...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Import Data Kelulusan')); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
                        ...
                        <a href="<?php echo e(route('admin.lulus.downloadTemplate')); ?>"
                    ...
                    <!-- Upload Form -->
                    <form method="POST" action="<?php echo e(route('admin.lulus.processImport')); ?>" enctype="multipart/form-data"
                        class="space-y-6">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\lulus\import.blade.php ENDPATH**/ ?>