...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('admin.log-monitoring.index')); ?>" class="btn btn-primary">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Error Message -->
        <?php if(session('error') || $errors->has('error')): ?>
            <div class="mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg flex items-center">
                ...
                <?php echo e(session('error') ?? $errors->first('error')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-slate-900"><?php echo e($stats['total_files']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-slate-900"><?php echo e($stats['total_size']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0 w-12 h-12 <?php echo e($stats['total_errors'] > 0 ? 'bg-red-100' : 'bg-green-100'); ?> rounded-lg flex items-center justify-center">
                        <svg class="w-6 h-6 <?php echo e($stats['total_errors'] > 0 ? 'text-red-600' : 'text-green-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold <?php echo e($stats['total_errors'] > 0 ? 'text-red-600' : 'text-green-600'); ?>"><?php echo e($stats['total_errors']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0 w-12 h-12 <?php echo e($stats['total_warnings'] > 0 ? 'bg-yellow-100' : 'bg-green-100'); ?> rounded-lg flex items-center justify-center">
                        <svg class="w-6 h-6 <?php echo e($stats['total_warnings'] > 0 ? 'text-yellow-600' : 'text-green-600'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold <?php echo e($stats['total_warnings'] > 0 ? 'text-yellow-600' : 'text-green-600'); ?>"><?php echo e($stats['total_warnings']); ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200">
                        ...
                        <tbody class="bg-white divide-y divide-slate-200">
                            <?php $__currentLoopData = $logFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <a href="<?php echo e(route('admin.log-monitoring.show', $log['name'])); ?>"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-slate-600"><?php echo e($log['size']); ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($log['errors'] > 0): ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                                <?php echo e($log['errors']); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-slate-600"><?php echo e($log['modified_human']); ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            <a href="<?php echo e(route('admin.log-monitoring.download', $log['name'])); ?>"
                                            ...
                                            ?>
                                            <?php if($log['name'] !== $activeLog): ?>
                                                <form action="<?php echo e(route('admin.log-monitoring.delete', $log['name'])); ?>"
                                                      method="POST"
                                                      class="inline"
                                                      onsubmit="return confirm('Apakah Anda yakin ingin menghapus log file <?php echo e($log['name']); ?>?')">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\log-monitoring\index.blade.php ENDPATH**/ ?>