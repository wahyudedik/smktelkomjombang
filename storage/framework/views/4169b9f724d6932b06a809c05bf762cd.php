...
<div class="rs-slider style1">
    <div class="rs-carousel owl-carousel" data-loop="true" data-items="1" data-margin="0" data-autoplay="true"
        ...
        <div class="slider-content slide1"
            style="background: url(<?php echo e(asset('assets_telkom/assets/images/slider/h2-1.jpg')); ?>); background-size: cover; background-position: center; background-repeat: no-repeat;">
            <!-- <div class="container">
                ...
                <h1 class="sl-title white-color wow fadeInRight" data-wow-delay="600ms"
                    data-wow-duration="2000ms">Educavo University</h1>
        ...
        <div class="slider-content slide2"
            style="background: url(<?php echo e(asset('assets_telkom/assets/images/slider/h2-2.jpg')); ?>); background-size: cover; background-position: center; background-repeat: no-repeat;">
            <!-- <div class="container">
            </div> -->
        </div>
        
        <!-- <div class="slider-content slide3"
            style="background: url(<?php echo e(asset('assets_telkom/assets/images/slider/coba.png')); ?>); background-size: cover; background-position: center; background-repeat: no-repeat;">
            <div class="container">
                <div class="sl-btn wow fadeInUp" data-wow-delay="900ms" data-wow-duration="2000ms">
                    <a class="readon2 banner-style" href="#">Discover More</a>
                </div>
