            ...
            <div class="mx-auto w-full max-w-lg bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div class="mt-10">
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg">
                        ...
                        <?php echo e(session('error', 'Link verifikasi tidak valid atau sudah expired.')); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\auth\verification-failed.blade.php ENDPATH**/ ?>