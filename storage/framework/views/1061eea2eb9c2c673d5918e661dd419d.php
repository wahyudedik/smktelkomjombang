...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-8 text-center lg:text-left">
                    <p class="text-base text-gray-700">
                        Kembali ke
                        <a href="<?php echo e(url()->previous()); ?>" class="font-medium text-blue-600 hover:text-blue-700">
                            halaman sebelumnya
                        </a>
                    </p>
                </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\auth\confirm-password.blade.php ENDPATH**/ ?>