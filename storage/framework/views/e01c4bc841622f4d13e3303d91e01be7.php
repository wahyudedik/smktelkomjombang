...
<?php $component->withAttributes([]); ?>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <?php else: ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                            <?php $__currentLoopData = $analyticsData['themes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $themeKey => $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    class="border rounded-lg p-4 <?php echo e($themeKey === ($activeTheme ?? config('app.default_theme', 'telkom')) ? 'border-green-400 bg-green-50' : 'border-gray-200'); ?>">
                                    <div class="flex items-center justify-between mb-3">
                                        <h4 class="font-bold text-gray-900">
                                            <?php echo e($themes[$themeKey]['short_name'] ?? $themeKey); ?>

                                        </h4>
                                        <?php if($themeKey === ($activeTheme ?? config('app.default_theme', 'telkom'))): ?>
                                            <span
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex justify-between text-sm">
                                            ...
                                            <span class="font-semibold text-gray-900"
                                                x-text="formatNumber(<?php echo e($stats['total_views']); ?>)"><?php echo e(number_format($stats['total_views'])); ?></span>
                                        </div>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-500">Unique Visitors</span>
                                            <span class="font-semibold text-gray-900"
                                                x-text="formatNumber(<?php echo e($stats['unique_visitors']); ?>)"><?php echo e(number_format($stats['unique_visitors'])); ?></span>
                                        </div>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-500">Avg. Time</span>
                                            <span class="font-semibold text-gray-900"><?php echo e($stats['avg_time_on_page']); ?>s</span>
                                        </div>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-500">Bounce Rate</span>
                                            <span class="font-semibold text-gray-900"><?php echo e($stats['bounce_rate']); ?>%</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Daily Views Chart -->
                        <?php if(count($analyticsData['daily_views']) > 0): ?>
                            <div class="mb-8">
                                    ...
                                    <div class="mb-4 last:mb-0">
                                        <div class="flex items-center justify-between mb-1">
                                            ...
                                            <span class="text-sm text-gray-500">
                                                <?php echo e(number_format($stats['total_views'])); ?> views
                                            </span>
                                        </div>
                                        <div class="w-full bg-gray-200 rounded-full h-3">
                                            <div class="h-3 rounded-full transition-all duration-500
                                                <?php echo e($themeKey === 'telkom' ? 'bg-blue-500' : 'bg-purple-500'); ?>"
    ...
    <script>
        ...
        <?php if($analyticsData['has_data'] && count($analyticsData['daily_views']) > 0): ?>
            // Daily Views Chart
            const dailyData = <?php echo json_encode($analyticsData['daily_views'], 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\settings\themes\analytics.blade.php ENDPATH**/ ?>