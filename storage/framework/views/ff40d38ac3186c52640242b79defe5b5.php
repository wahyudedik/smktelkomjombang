...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="saranaForm()">
        ...
        <form method="POST" action="<?php echo e(route('admin.sarpras.sarana.store')); ?>" id="saranaForm" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" id="tanggal" name="tanggal" value="<?php echo e(old('tanggal', date('Y-m-d'))); ?>"
                            required
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Masukkan catatan (opsional)"><?php echo e(old('catatan')); ?></textarea>
            ...
            function saranaForm() {
                return {
                    ...
                    async loadBarangByRuang(ruangId) {
                        this.loading = true;
                        try {
                            const response = await fetch(`<?php echo e(route('admin.sarpras.sarana.getBarangByRuang')); ?>?ruang_id=${ruangId}`);
...
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\sarana\create.blade.php ENDPATH**/ ?>