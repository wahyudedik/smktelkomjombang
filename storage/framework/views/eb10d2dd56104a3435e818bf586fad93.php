     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <!-- Date Range Filter -->
                <form method="GET" action="<?php echo e(route('admin.analytics')); ?>" class="flex flex-wrap items-center gap-2">
                    <input type="date" name="start_date" value="<?php echo e($analytics['date_range']['start']); ?>"
                        class="px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    <span class="text-slate-500">to</span>
                    <input type="date" name="end_date" value="<?php echo e($analytics['date_range']['end']); ?>"
                        class="px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-cloak
                        ...
                        <a href="<?php echo e(route('admin.analytics.export', ['format' => 'json', 'start_date' => $analytics['date_range']['start'], 'end_date' => $analytics['date_range']['end']])); ?>"
                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100">Export as JSON</a>
                        <a href="<?php echo e(route('admin.analytics.export', ['format' => 'csv', 'start_date' => $analytics['date_range']['start'], 'end_date' => $analytics['date_range']['end']])); ?>"
                ...
                initCharts() {
                    ...
                    if (userInvCtx) {
                        this.charts.userInvitations = new Chart(userInvCtx, {
                            type: 'line',
                            data: {
                                labels: <?php echo json_encode(array_column($analytics['trends']['user_invitations'], 'date'), 512) ?>,
                                datasets: [{
                                    label: 'New Users',
                                    data: <?php echo json_encode(array_column($analytics['trends']['user_invitations'], 'count'), 512) ?>,
                    ...
                    if (moduleUsageCtx) {
                        const moduleData = <?php echo json_encode($analytics['trends']['module_usage'], 15, 512) ?>;
                    ...
                    <?php if(isset($analytics['audit_analytics']['actions_by_type']) &&
                            count($analytics['audit_analytics']['actions_by_type']) > 0): ?>
                        const actionsTypeCtx = document.getElementById('actionsByTypeChart');
                        if (actionsTypeCtx) {
                            const actionsData = <?php echo json_encode($analytics['audit_analytics']['actions_by_type'], 15, 512) ?>;
                    ...
                    // Peak Hours Chart
                    <?php if(isset($analytics['audit_analytics']['peak_hours']) && count($analytics['audit_analytics']['peak_hours']) > 0): ?>
                        const peakHoursCtx = document.getElementById('peakHoursChart');
                        if (peakHoursCtx) {
                            const peakData = <?php echo json_encode($analytics['audit_analytics']['peak_hours'], 15, 512) ?>;
                    ...
                    // Feature Usage Chart
                    <?php if(isset($analytics['engagement']['feature_usage'])): ?>
                        const featureUsageCtx = document.getElementById('featureUsageChart');
                        if (featureUsageCtx) {
                            const featureData = <?php echo json_encode($analytics['engagement']['feature_usage'], 15, 512) ?>;
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="analyticsDashboard()">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        ...
                        <?php if(isset($analytics['user_activity']['user_growth'])): ?>
                            <p class="text-xs text-slate-500 mt-1">
                                <span
                                    class="<?php echo e($analytics['user_activity']['user_growth']['growth_rate'] >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                    <?php echo e($analytics['user_activity']['user_growth']['growth_rate'] >= 0 ? '↑' : '↓'); ?>

                                    <?php echo e(abs($analytics['user_activity']['user_growth']['growth_rate'])); ?>%
                                </span>
                                vs previous period
                            </p>
                        <?php endif; ?>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-900 mt-2">
                            <?php echo e(number_format($analytics['user_activity']['active_users'] ?? 0)); ?></p>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-slate-900 mt-2">
                            <?php echo e(number_format($analytics['audit_analytics']['total_actions'] ?? 0)); ?></p>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 mt-2">
                            <?php echo e(ucfirst($analytics['performance']['system_health']['system_status'] ?? 'Healthy')); ?></p>
                        <p class="text-xs text-slate-500 mt-1">
                            <?php echo e($analytics['performance']['system_health']['active_modules'] ?? 0); ?>/<?php echo e($analytics['performance']['system_health']['total_modules'] ?? 6); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="p-3 bg-slate-50 rounded-lg">
                            ...
                            <p class="text-xl font-bold text-slate-900">
                                <?php echo e($analytics['user_activity']['invited_users_last_24h'] ?? 0); ?></p>
                        </div>
                        <div class="p-3 bg-slate-50 rounded-lg">
                            <p class="text-xs text-slate-500">This Week</p>
                            <p class="text-xl font-bold text-slate-900">
                                <?php echo e($analytics['user_activity']['invited_users_this_week'] ?? 0); ?></p>
                        </div>
                        <div class="p-3 bg-slate-50 rounded-lg">
                            <p class="text-xs text-slate-500">This Month</p>
                            <p class="text-xl font-bold text-slate-900">
                                <?php echo e($analytics['user_activity']['invited_users_this_month'] ?? 0); ?></p>
                        </div>
                        <div class="p-3 bg-slate-50 rounded-lg">
                            <p class="text-xs text-slate-500">Selected Range</p>
                            <p class="text-xl font-bold text-slate-900">
                                <?php echo e($analytics['user_activity']['invited_users_in_range'] ?? 0); ?></p>
                        </div>
                    </div>
                            ...
                            <?php $__currentLoopData = $analytics['user_activity']['user_distribution']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                    <div class="flex flex-wrap items-center gap-2">
                                        ...
                                        <span class="text-sm text-slate-700 capitalize"><?php echo e($role); ?></span>
                                    </div>
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <span
                                            class="text-sm font-semibold text-slate-900 w-12 text-right"><?php echo e($count); ?></span>
                                    </div>
                                </div>
                            ...
                            <div class="grid grid-cols-3 gap-3 text-center">
                                <div>
                                    ...
                                    <p class="text-lg font-bold text-green-600">
                                        <?php echo e($analytics['user_activity']['user_growth']['new_users']); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-500">Growth Rate</p>
                                    <p class="text-lg font-bold text-blue-600">
                                        <?php echo e($analytics['user_activity']['user_growth']['growth_rate']); ?>%</p>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-500">Total Users</p>
                                    <p class="text-lg font-bold text-slate-900">
                                        <?php echo e($analytics['user_activity']['user_growth']['end_count']); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div class="space-y-4">
                    <?php if(isset($analytics['engagement']['voting_engagement'])): ?>
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-purple-900">
                                        <?php echo e($analytics['engagement']['voting_engagement']['participation_rate']); ?>%</p>
                                </div>
                                <div>
                                    <p class="text-xs text-purple-700">Avg Votes/Voter</p>
                                    <p class="text-2xl font-bold text-purple-900">
                                        <?php echo e($analytics['engagement']['voting_engagement']['average_votes_per_voter']); ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-purple-900">
                                        <?php echo e($analytics['engagement']['voting_engagement']['candidates_per_vote']); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>

                    <?php if(isset($analytics['engagement']['module_adoption'])): ?>
                        <div>
                            <h4 class="text-sm font-medium text-slate-700 mb-3">Module Adoption Rates</h4>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $analytics['engagement']['module_adoption']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <div class="flex justify-between items-center mb-1">
                                            <span class="text-sm text-slate-700 capitalize"><?php echo e($module); ?></span>
                                            <span
                                                class="text-sm font-semibold text-slate-900"><?php echo e($data['adoption_rate']); ?>%</span>
                                        </div>
                                        <div class="w-full bg-slate-200 rounded-full h-2">
                                            <div class="bg-green-500 h-2 rounded-full"
                                                style="width: <?php echo e(min($data['adoption_rate'], 100)); ?>%"></div>
                                        </div>
                                        <p class="text-xs text-slate-500 mt-1">
                                            <?php echo e($data['actual_voters'] ?? ($data['actual_applicants'] ?? 0)); ?> of
                                            <?php echo e($data['users_with_access']); ?> users
                                        </p>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                    ...
                    <?php if(isset($analytics['engagement']['user_retention'])): ?>
                        <div class="pt-4 border-t">
                            ...
                            <div class="grid grid-cols-3 gap-3 text-center">
                                <div>
                                    <p class="text-xs text-slate-500">New Users</p>
                                    <p class="text-lg font-bold text-slate-900">
                                        <?php echo e($analytics['engagement']['user_retention']['new_users']); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-500">Active Users</p>
                                    <p class="text-lg font-bold text-green-600">
                                        <?php echo e($analytics['engagement']['user_retention']['active_users']); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-500">Retention</p>
                                    <p class="text-lg font-bold text-blue-600">
                                        <?php echo e($analytics['engagement']['user_retention']['retention_rate']); ?>%</p>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <?php if(isset($analytics['audit_analytics']['most_active_users']) &&
                    ...
                    <div class="pt-4 border-t">
                        ...
                        <div class="space-y-2 max-h-64 overflow-y-auto">
                            <?php $__currentLoopData = array_slice($analytics['audit_analytics']['most_active_users'], 0, 10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-2 hover:bg-slate-50 rounded">
                                    ...
                                    <div class="text-right">
                                        <p class="text-sm font-bold text-blue-600"><?php echo e($user['activity_count']); ?></p>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <?php if(isset($analytics['performance']['module_efficiency'])): ?>
                    <div class="space-y-4 mb-6">
                        <div>
                            <h4 class="text-sm font-medium text-slate-700 mb-3">Module Efficiency</h4>
                            <?php $__currentLoopData = $analytics['performance']['module_efficiency']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-4">
                                    <div class="flex justify-between items-center mb-1">
                                        <span class="text-sm text-slate-700 capitalize"><?php echo e($module); ?></span>
                                        <span
                                            class="text-sm font-semibold text-slate-900"><?php echo e($data['efficiency'] ?? ($data['approval_rate'] ?? ($data['maintenance_rate'] ?? 0))); ?>%</span>
                                    </div>
                                    <div class="w-full bg-slate-200 rounded-full h-2">
                                        <div class="bg-yellow-500 h-2 rounded-full"
                                            style="width: <?php echo e(min($data['efficiency'] ?? ($data['approval_rate'] ?? ($data['maintenance_rate'] ?? 0)), 100)); ?>%">
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(isset($analytics['performance']['database_performance']['largest_tables'])): ?>
                    <div class="pt-4 border-t">
                        <h4 class="text-sm font-medium text-slate-700 mb-3">Largest Tables</h4>
                        <div class="space-y-2">
                            <?php $__currentLoopData = $analytics['performance']['database_performance']['largest_tables']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-2 hover:bg-slate-50 rounded">
                                    <span
                                        class="text-sm text-slate-700 capitalize"><?php echo e(str_replace('_', ' ', $table['table'])); ?></span>
                                    <span
                                        class="text-sm font-bold text-slate-900"><?php echo e(number_format($table['count'])); ?>
                ...
                <div class="border border-slate-200 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span
                                class="text-sm font-bold text-slate-900"><?php echo e($analytics['module_usage']['e_osis']['total_candidates']); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-slate-600">Voters</span>
                            <span
                                class="text-sm font-bold text-slate-900"><?php echo e($analytics['module_usage']['e_osis']['total_voters']); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-slate-600">Participation</span>
                            <span
                                class="text-sm font-bold text-green-600"><?php echo e($analytics['module_usage']['e_osis']['voting_participation']); ?>%</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-slate-200 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span
                                class="text-sm font-bold text-slate-900"><?php echo e($analytics['module_usage']['e_lulus']['total_graduates']); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-slate-600">Pending</span>
                            <span
                                class="text-sm font-bold text-orange-600"><?php echo e($analytics['module_usage']['e_lulus']['pending_verification']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="border border-slate-200 rounded-lg p-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span
                                class="text-sm font-bold text-slate-900"><?php echo e($analytics['module_usage']['sarpras']['total_assets']); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-slate-600">Maintenance Due</span>
                            <span
                                class="text-sm font-bold text-red-600"><?php echo e($analytics['module_usage']['sarpras']['maintenance_due']); ?></span>
                        </div>
                        <div class="space-y-1 mt-2 pt-2 border-t">
                            <?php $__currentLoopData = $analytics['module_usage']['sarpras']['assets_by_condition']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $condition => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between text-xs">
                                    <span class="text-slate-600 capitalize"><?php echo e($condition); ?></span>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\analytics\dashboard.blade.php ENDPATH**/ ?>