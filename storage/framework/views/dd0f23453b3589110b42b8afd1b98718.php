                ...
                <div class="row rs-counter couter-area mb-40">
                    ...
                    <div class="col-md-4">
                        <div class="counter-item two">
                            <h2 class="number rs-count"><?php echo e($siteSettings['counter2_number'] ?? '4'); ?></h2>
                            <h4 class="title mb-0"><?php echo e($siteSettings['counter2_label'] ?? 'Jurusan'); ?></h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="counter-item three">
                            <h2 class="number rs-count percent"><?php echo e($siteSettings['counter3_number'] ?? ($kelulusanPercentage > 0 ? $kelulusanPercentage : '75')); ?></h2>
...
<!-- About Section End -->
<?php /**PATH E:\PROJEKU\telkom\resources\views\components\telkom\about.blade.php ENDPATH**/ ?>