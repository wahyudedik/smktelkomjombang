...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('admin.sarpras.ruang.show', $ruang)); ?>" class="btn btn-secondary">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl border border-slate-200 p-8">
            <form method="POST" action="<?php echo e(route('admin.sarpras.ruang.update', $ruang)); ?>" enctype="multipart/form-data"
                class="space-y-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="nama_ruang" name="nama_ruang"
                                value="<?php echo e(old('nama_ruang', $ruang->nama_ruang)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="kode_ruang" name="kode_ruang"
                                value="<?php echo e(old('kode_ruang', $ruang->kode_ruang)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="jenis_ruang" name="jenis_ruang"
                                class="form-input <?php $__errorArgs = ['jenis_ruang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="Kelas"
                                    <?php echo e(old('jenis_ruang', $ruang->jenis_ruang) == 'Kelas' ? 'selected' : ''); ?>>Kelas
                                </option>
                                <option value="Laboratorium"
                                    <?php echo e(old('jenis_ruang', $ruang->jenis_ruang) == 'Laboratorium' ? 'selected' : ''); ?>>
                                    Laboratorium</option>
                                <option value="Perpustakaan"
                                    <?php echo e(old('jenis_ruang', $ruang->jenis_ruang) == 'Perpustakaan' ? 'selected' : ''); ?>>
                                    Perpustakaan</option>
                                <option value="Kantor"
                                    <?php echo e(old('jenis_ruang', $ruang->jenis_ruang) == 'Kantor' ? 'selected' : ''); ?>>Kantor
                                </option>
                                <option value="Aula"
                                    <?php echo e(old('jenis_ruang', $ruang->jenis_ruang) == 'Aula' ? 'selected' : ''); ?>>Aula
                                </option>
                                <option value="Lainnya"
                                    <?php echo e(old('jenis_ruang', $ruang->jenis_ruang) == 'Lainnya' ? 'selected' : ''); ?>>
                                    Lainnya</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="kapasitas" name="kapasitas"
                                value="<?php echo e(old('kapasitas', $ruang->kapasitas)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="kondisi" name="kondisi"
                                class="form-input <?php $__errorArgs = ['kondisi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="baik"
                                    <?php echo e(old('kondisi', $ruang->kondisi) == 'baik' ? 'selected' : ''); ?>>Baik</option>
                                <option value="rusak"
                                    <?php echo e(old('kondisi', $ruang->kondisi) == 'rusak' ? 'selected' : ''); ?>>Rusak</option>
                                <option value="renovasi"
                                    <?php echo e(old('kondisi', $ruang->kondisi) == 'renovasi' ? 'selected' : ''); ?>>Renovasi
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="aktif"
                                    <?php echo e(old('status', $ruang->status) == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                                <option value="tidak_aktif"
                                    <?php echo e(old('status', $ruang->status) == 'tidak_aktif' ? 'selected' : ''); ?>>Tidak Aktif
                                </option>
                                <option value="renovasi"
                                    <?php echo e(old('status', $ruang->status) == 'renovasi' ? 'selected' : ''); ?>>Renovasi
                                </option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="luas_ruang" name="luas_ruang"
                                value="<?php echo e(old('luas_ruang', $ruang->luas_ruang)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="gedung" name="gedung"
                                value="<?php echo e(old('gedung', $ruang->gedung)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="lantai" name="lantai"
                                value="<?php echo e(old('lantai', $ruang->lantai)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            <?php if($ruang->foto): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e($ruang->photo_url); ?>" alt="Current photo"
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Masukkan daftar fasilitas yang tersedia (pisahkan dengan koma)"><?php echo e(old('fasilitas', $ruang->facilities_list)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Masukkan deskripsi ruang"><?php echo e(old('deskripsi', $ruang->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Masukkan catatan tambahan"><?php echo e(old('catatan', $ruang->catatan)); ?></textarea>
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" id="is_active" name="is_active" value="1"
                            <?php echo e(old('is_active', $ruang->is_active) ? 'checked' : ''); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\ruang\edit.blade.php ENDPATH**/ ?>