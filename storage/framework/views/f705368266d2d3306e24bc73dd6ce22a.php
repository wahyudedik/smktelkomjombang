                ...
                <div class="bg-white rounded-xl border border-slate-200 p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-slate-900 mt-1"><?php echo e(number_format($stats['total_users'])); ?>
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-slate-900 mt-1"><?php echo e(number_format($stats['total_siswa'])); ?>
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-slate-900 mt-1"><?php echo e(number_format($stats['total_guru'])); ?>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-slate-900 mt-1">
                                <?php echo e(number_format($stats['total_barang'])); ?></p>
                        </div>
                    ...
                    <div class="p-6">
                        <form class="import-form" data-module="users">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('admin.superadmin.bulk-import.template', 'users')); ?>"
                ...
                <div
                    ...
                    <div class="p-6">
                        <form class="import-form" data-module="siswa">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('admin.superadmin.bulk-import.template', 'siswa')); ?>"
                                    class="flex-1 btn btn-secondary text-center">
                                    <i class="fas fa-download mr-2"></i>
                                    Template
                                </a>
                ...
                <div
                    ...
                    <div class="p-6">
                        <form class="import-form" data-module="guru">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('admin.superadmin.bulk-import.template', 'guru')); ?>"
                                    class="flex-1 btn btn-secondary text-center">
                                    <i class="fas fa-download mr-2"></i>
                                    Template
                                </a>
                ...
                <div
                    ...
                    <div class="p-6">
                        <form class="import-form" data-module="barang">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('admin.superadmin.bulk-import.template', 'barang')); ?>"
                                    class="flex-1 btn btn-secondary text-center">
                                    <i class="fas fa-download mr-2"></i>
                                    Template
                                </a>
                ...
                <div
                    ...
                    <div class="p-6">
                        <form class="import-form" data-module="calon">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('admin.superadmin.bulk-import.template', 'calon')); ?>"
                                    class="flex-1 btn btn-secondary text-center">
                                    <i class="fas fa-download mr-2"></i>
                                    Template
                                </a>
                ...
                <div
                    ...
                    <div class="p-6">
                        <form class="import-form" data-module="pemilih">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('admin.superadmin.bulk-import.template', 'pemilih')); ?>"
                                    class="flex-1 btn btn-secondary text-center">
                                    <i class="fas fa-download mr-2"></i>
                                    Template
                                </a>
                ...
                <div
                    ...
                    <div class="p-6">
                        <form class="import-form" data-module="kelulusan">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('admin.superadmin.bulk-import.template', 'kelulusan')); ?>"
                                    class="flex-1 btn btn-secondary text-center">
                                    <i class="fas fa-download mr-2"></i>
                                    Template
                                </a>
                    ...
                    form.addEventListener('submit', async function(e) {
                        ...
                        try {
                            const response = await fetch(
                                '<?php echo e(route('admin.superadmin.bulk-import.process')); ?>', {
                                    method: 'POST',
                                    body: formData
                                });
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\admin\bulk-import\index.blade.php ENDPATH**/ ?>