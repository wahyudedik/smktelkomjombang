...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8" x-data="saranaForm()">
        <form method="POST" action="<?php echo e(route('admin.sarpras.sarana.update', $sarana)); ?>" id="saranaForm" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $ruangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($ruang->id); ?>" <?php echo e($sarana->ruang_id == $ruang->id ? 'selected' : ''); ?>>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" id="tanggal" name="tanggal" value="<?php echo e(old('tanggal', $sarana->tanggal->format('Y-m-d'))); ?>"
                            required
                            class="form-input <?php $__errorArgs = ['tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Masukkan catatan (opsional)"><?php echo e(old('catatan', $sarana->catatan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="hidden" name="sumber_dana" x-model="sumberDana" value="<?php echo e($sarana->sumber_dana); ?>">
            <input type="hidden" name="kode_sumber_dana" x-model="kodeSumberDana" value="<?php echo e($sarana->kode_sumber_dana); ?>" required>

            <!-- Submit Button -->
            <div class="flex items-center justify-end space-x-4">
                <a href="<?php echo e(route('admin.sarpras.sarana.index')); ?>" class="btn btn-secondary">Batal</a>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="modal_sumber_dana" x-model="sumberDana"
                                class="form-input" placeholder="Contoh: BOS, APBD, dll" value="<?php echo e($sarana->sumber_dana); ?>">
                        </div>
                        <div>
                            ...
                            <input type="text" id="modal_kode_sumber_dana" x-model="kodeSumberDana" required
                                class="form-input" placeholder="Contoh: MAUDU/2025" value="<?php echo e($sarana->kode_sumber_dana); ?>">
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            function saranaForm() {
                return {
                    ruangId: '<?php echo e($sarana->ruang_id); ?>',
                    barangs: <?php echo json_encode($saranaBarangsJson, 15, 512) ?>.map(b => ({
                    ...
                    filteredBarangs: [],
                    sumberDana: '<?php echo e($sarana->sumber_dana); ?>',
                    kodeSumberDana: '<?php echo e($sarana->kode_sumber_dana); ?>',
                    showModal: false,
                    loading: false,
                    ...
                    init() {
                        ...
                        this.$watch('ruangId', (value) => {
                            if (value && value !== '<?php echo e($sarana->ruang_id); ?>') {
                    ...
                    async loadBarangByRuang(ruangId, preserveExisting = false) {
                        this.loading = true;
                        try {
                            const response = await fetch(`<?php echo e(route('admin.sarpras.sarana.getBarangByRuang')); ?>?ruang_id=${ruangId}&sarana_id=<?php echo e($sarana->id); ?>`);
...
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\sarana\edit.blade.php ENDPATH**/ ?>