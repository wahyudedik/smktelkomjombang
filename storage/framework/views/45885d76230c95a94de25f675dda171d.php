                ...
                <div class="col-md-6 col-lg-2">
                    <div class="footer-widget-box list">
                        ...
                        <ul class="footer-list">
                            <li><a href="<?php echo e(resolve_theme_url('route:pages.public.show,tentang-yayasan')); ?>"><i class="fas fa-caret-right"></i> Tentang Yayasan</a></li>
                            <li><a href="<?php echo e(resolve_theme_url('route:pages.public.show,tentang-madrasah')); ?>"><i class="fas fa-caret-right"></i> Tentang Madrasah</a></li>
                            <li><a href="<?php echo e(resolve_theme_url('route:testimonials.create')); ?>"><i class="fas fa-caret-right"></i> Testimonials</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="footer-widget-box list">
                        ...
                        <ul class="footer-list">
                            ...
                            <li><a href="<?php echo e(resolve_theme_url('route:public.graduation.check')); ?>"><i class="fas fa-caret-right"></i> E-Lulus</a></li>
