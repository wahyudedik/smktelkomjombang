        ...
        <div class="row y-middle">
            <div class="col-lg-4 col-md-6 mb-30">
                <div class="sec-title wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                    <div class="sub-title primary"><?php echo e($siteSettings['program_section_subtitle'] ?? 'Kerjasama Industri'); ?></div>
                    <h2 class="title mb-0"><?php echo e($siteSettings['program_section_title'] ?? 'Kurikulum dan Pengajar'); ?></h2>
                </div>
            </div>
            <?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="degree-wrap">
                        <img src="<?php echo e(asset('assets_telkom/assets/images/degrees/' . ($loop->index + 1) . '.jpg')); ?>" alt="<?php echo e($partner->name); ?>">
                        <div class="title-part">
                            <h4 class="title"><?php echo e($partner->name); ?></h4>
                        </div>
                        <div class="content-part">
                            <h4 class="title"><a href="#"><?php echo e($partner->name); ?></a></h4>
                            <p class="desc"><?php echo e($partner->description); ?></p>
                            <div class="btn-part">
                                <a href="#">Detail</a>
                            </div>
                        </div>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="degree-wrap">
                        <img src="<?php echo e(asset('assets_telkom/assets/images/degrees/1.jpg')); ?>" alt="Axioo">
                        <div class="title-part">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="degree-wrap">
                        <img src="<?php echo e(asset('assets_telkom/assets/images/degrees/2.jpg')); ?>" alt="GAMELAB">
                        <div class="title-part">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="degree-wrap">
                        <img src="<?php echo e(asset('assets_telkom/assets/images/degrees/3.jpg')); ?>" alt="Lab PLTS">
                        <div class="title-part">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="degree-wrap">
                        <img src="<?php echo e(asset('assets_telkom/assets/images/degrees/4.jpg')); ?>" alt="Lab Fiber Optik">
                        <div class="title-part">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="degree-wrap">
                        <img src="<?php echo e(asset('assets_telkom/assets/images/degrees/5.jpg')); ?>" alt="Studio Seje">
                        <div class="title-part">
...
<!-- Degree Section End -->
<?php /**PATH E:\PROJEKU\telkom\resources\views/components/telkom/programs.blade.php ENDPATH**/ ?>