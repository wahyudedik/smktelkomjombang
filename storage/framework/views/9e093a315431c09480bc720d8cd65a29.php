...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <h1 class="text-2xl font-bold text-slate-900"><?php echo e(__('common.e_osis_dashboard')); ?></h1>
                <p class="text-slate-600 mt-1"><?php echo e(__('common.digital_election_system')); ?></p>
            </div>
            <div class="flex flex-wrap items-center gap-2">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export', App\Models\Calon::class)): ?>
                    <a href="<?php echo e(route('admin.osis.calon.export')); ?>" class="btn btn-secondary">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <?php echo e(__('common.export_calon')); ?>

                    </a>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export', App\Models\Calon::class)): ?>
                    <a href="<?php echo e(route('admin.osis.pemilih.export')); ?>" class="btn btn-secondary">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <?php echo e(__('common.export_pemilih')); ?>
                ...
                <span
                    ...
                    <?php echo e(__('common.voting_active')); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-slate-600"><?php echo e(__('common.total_calon')); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('admin.osis.calon.create')); ?>"
                    ...
                    <a href="<?php echo e(route('admin.osis.pemilih.create')); ?>"
                    ...
                    <a href="<?php echo e(route('admin.osis.pemilih.import')); ?>"
                        class="flex items-center justify-between p-3 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors group">
                        <div class="flex items-center space-x-3">
                            <div class="w-8 h-8 bg-purple-600 rounded-lg flex items-center justify-center">
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
            ...
            <div class="lg:col-span-2 bg-white rounded-xl border border-slate-200 p-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                    ...
                    <a href="<?php echo e(route('admin.osis.calon.index')); ?>"
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $calons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $calon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                            <div class="flex items-center space-x-4">
                                <div class="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center">
                                    <span class="text-lg font-bold text-orange-600"><?php echo e($loop->iteration); ?></span>
                                </div>
                                <div>
                                    <h4 class="font-medium text-slate-900"><?php echo e($calon->full_candidate_name); ?></h4>
                    ...
                    <div class="flex items-center space-x-3 p-3 hover:bg-slate-50 rounded-lg transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm text-slate-900">
                                <span class="font-medium"><?php echo e($vote->pemilih->nama); ?></span>
                                memilih
    ...
    <?php if(session('success')): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const successKey = 'osis_index_success_' + '<?php echo e(md5(session('success') . time())); ?>';
    ...
    <?php if(session('error')): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const errorKey = 'osis_index_error_' + '<?php echo e(md5(session('error') . time())); ?>';
    ...
    <?php if(session('info')): ?>
        <script>
            const infoKey = 'osis_index_info_' + '<?php echo e(md5(session('info') . time())); ?>';
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\osis\index.blade.php ENDPATH**/ ?>