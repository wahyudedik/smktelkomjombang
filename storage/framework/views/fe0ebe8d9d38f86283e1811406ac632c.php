                        ...
                        <a href="/" class="footer-logo">
                            <?php if(cache('site_setting_logo')): ?>
                                <img src="<?php echo e(Storage::url(cache('site_setting_logo'))); ?>"
                                    alt="<?php echo e(cache('site_setting_site_name', 'SMK Telekomunikasi')); ?>"
                                    style="max-height: 50px; filter: brightness(0) invert(1);">
                            <?php else: ?>
                                <img src="<?php echo e(theme_image('logo_light', theme_info('defaults.logo_light', 'assets_telkom/assets/images/logo.png'))); ?>" alt="<?php echo e(theme_info('name', config('app.name'))); ?>">
                            <?php endif; ?>
                        </a>
                        <p class="mb-3">
...
<!-- scroll-top end -->
<?php /**PATH E:\PROJEKU\telkom\resources\views/components/landing/footer.blade.php ENDPATH**/ ?>