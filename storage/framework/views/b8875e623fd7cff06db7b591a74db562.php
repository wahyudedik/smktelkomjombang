    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex flex-wrap items-center gap-2">
                        ...
                        <div class="relative group">
                            ...
                            <div
                                ...
                                <div class="py-2">
                                    ...
                                    <?php endif; ?>
                                    <?php if(Auth::check() && (Auth::user()->hasAnyRole(['admin', 'superadmin']) || Auth::user()->can('events.view'))): ?>
                                        <a href="<?php echo e(route('admin.events.index')); ?>"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">
                                            <i class="fas fa-calendar-alt mr-2"></i>Events / Kegiatan
                                        </a>
                                    <?php endif; ?>
                                    <?php if(Auth::check() && (Auth::user()->hasAnyRole(['admin', 'superadmin']) || Auth::user()->can('berita.view'))): ?>
                            ...
                            <div
                                ...
                                <div class="py-2">
                                    <?php if(Auth::user()->hasAnyRole(['superadmin', 'admin']) ||
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['roles.view', 'roles.create', 'roles.edit', 'roles.delete'])): ?>
                                        <a href="<?php echo e(route('admin.role-permissions.index')); ?>"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">
                                            <i class="fas fa-shield-alt mr-2"></i>Role & Permissions
                                        </a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['permissions.view', 'permissions.create', 'permissions.edit', 'permissions.delete'])): ?>
                                        <a href="<?php echo e(route('admin.permissions.index')); ?>"
                                            class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50">
                                            <i class="fas fa-key mr-2"></i>Permission Management
                                        </a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['system.analytics'])): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['system.health'])): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['notification.view', 'notification.manage', 'system.notifications'])): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['settings.view', 'settings.manage'])): ?>
...
<?php /**PATH E:\PROJEKU\telkom\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>