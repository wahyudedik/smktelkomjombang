...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('admin.sarpras.barang.show', $barang)); ?>" class="btn btn-secondary">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl border border-slate-200 p-8">
            <form method="POST" action="<?php echo e(route('admin.sarpras.barang.update', $barang)); ?>" enctype="multipart/form-data"
                class="space-y-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="nama_barang" name="nama_barang"
                                ...
                                class="form-input <?php $__errorArgs = ['nama_barang'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="kode_barang" name="kode_barang"
                                value="<?php echo e(old('kode_barang', $barang->kode_barang)); ?>"
                                class="form-input <?php $__errorArgs = ['kode_barang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="kategori_id" name="kategori_id"
                                class="form-input <?php $__errorArgs = ['kategori_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kategori->id); ?>"
                                        <?php echo e(old('kategori_id', $barang->kategori_id) == $kategori->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="ruang_id" name="ruang_id"
                                class="form-input <?php $__errorArgs = ['ruang_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $ruangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ruang->id); ?>"
                                        <?php echo e(old('ruang_id', $barang->ruang_id) == $ruang->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="baik"
                                    <?php echo e(old('kondisi', $barang->kondisi) == 'baik' ? 'selected' : ''); ?>>Baik</option>
                                <option value="rusak"
                                    <?php echo e(old('kondisi', $barang->kondisi) == 'rusak' ? 'selected' : ''); ?>>Rusak</option>
                                <option value="hilang"
                                    <?php echo e(old('kondisi', $barang->kondisi) == 'hilang' ? 'selected' : ''); ?>>Hilang
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="tersedia"
                                    <?php echo e(old('status', $barang->status) == 'tersedia' ? 'selected' : ''); ?>>Tersedia
                                </option>
                                <option value="dipinjam"
                                    <?php echo e(old('status', $barang->status) == 'dipinjam' ? 'selected' : ''); ?>>Dipinjam
                                </option>
                                <option value="rusak"
                                    <?php echo e(old('status', $barang->status) == 'rusak' ? 'selected' : ''); ?>>Rusak</option>
                                <option value="hilang"
                                    <?php echo e(old('status', $barang->status) == 'hilang' ? 'selected' : ''); ?>>Hilang</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="harga_beli" name="harga_beli"
                                value="<?php echo e(old('harga_beli', $barang->harga_beli)); ?>"
                                class="form-input <?php $__errorArgs = ['harga_beli'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_pembelian" name="tanggal_pembelian"
                                value="<?php echo e(old('tanggal_pembelian', $barang->tanggal_pembelian ? $barang->tanggal_pembelian->format('Y-m-d') : '')); ?>"
                                class="form-input <?php $__errorArgs = ['tanggal_pembelian'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            <?php if($barang->photo_url): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e($barang->photo_url); ?>" alt="Current photo"
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Masukkan deskripsi barang"><?php echo e(old('deskripsi', $barang->deskripsi)); ?></textarea>
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="checkbox" id="is_active" name="is_active" value="1"
                            <?php echo e(old('is_active', $barang->is_active) ? 'checked' : ''); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\barang\edit.blade.php ENDPATH**/ ?>