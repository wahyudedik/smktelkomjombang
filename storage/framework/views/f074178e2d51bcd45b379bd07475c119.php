    ...
    <div class="min-h-screen flex bg-gray-50">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-6 lg:px-16 xl:px-20 bg-white">
            <div class="mx-auto w-full max-w-lg bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <!-- Form -->
                <div class="mt-10">
                    <form action="<?php echo e(route('verification.resend-guest')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\auth\resend-verification.blade.php ENDPATH**/ ?>