...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl border border-slate-200 p-8">
            <form method="POST" action="<?php echo e(route('admin.sarpras.kategori.store')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="kode_kategori" name="kode_kategori"
                                value="<?php echo e(old('kode_kategori')); ?>"
                                class="form-input <?php $__errorArgs = ['kode_kategori'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_kategori" name="nama_kategori"
                                ...
                                class="form-input <?php $__errorArgs = ['nama_kategori'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Masukkan deskripsi kategori"><?php echo e(old('deskripsi')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\kategori\create.blade.php ENDPATH**/ ?>