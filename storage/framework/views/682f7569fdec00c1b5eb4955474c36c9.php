...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.berita.update', $berita)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="title" value="<?php echo e(old('title', $berita->title)); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('excerpt', $berita->excerpt)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <textarea name="content" id="content" class="hidden"><?php echo e(old('content', $berita->content)); ?></textarea>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                            <div id="image-preview" class="mt-3 hidden">
                                <p class="text-xs text-slate-500 mb-1">Preview baru:</p>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="archived" <?php echo e(old('status', $berita->status) === 'archived' ? 'selected' : ''); ?>>
                                        Arsip
                                    </option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($berita->published_at): ?>
                                <p class="text-xs text-slate-500">
                                    ...
                                    Dipublish: <?php echo e($berita->published_at->format('d M Y H:i')); ?>
    ...
    <script>
        ...
        // Fallback: sync saat tombol submit diklik
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views/berita/edit.blade.php ENDPATH**/ ?>