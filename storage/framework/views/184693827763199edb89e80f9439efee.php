     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Edit Jadwal Pelajaran')); ?>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="<?php echo e(route('admin.jadwal-pelajaran.update', $jadwalPelajaran)); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $mataPelajaranList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mapel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($mapel->id); ?>"
                                            <?php echo e(old('mata_pelajaran_id', $jadwalPelajaran->mata_pelajaran_id) == $mapel->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $guruList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($guru->id); ?>"
                                            <?php echo e(old('guru_id', $jadwalPelajaran->guru_id) == $guru->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($kelas->id); ?>"
                                            <?php echo e(old('kelas_id', $jadwalPelajaran->kelas_id) == $kelas->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $hariList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($hari); ?>"
                                            <?php echo e(old('hari', $jadwalPelajaran->hari) == $hari ? 'selected' : ''); ?>>
                                            <?php echo e($hari); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="time" name="jam_mulai"
                                    value="<?php echo e(old('jam_mulai', \Carbon\Carbon::parse($jadwalPelajaran->jam_mulai)->format('H:i'))); ?>"
                                    required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="time" name="jam_selesai"
                                    value="<?php echo e(old('jam_selesai', \Carbon\Carbon::parse($jadwalPelajaran->jam_selesai)->format('H:i'))); ?>"
                                    required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="ruang"
                                    value="<?php echo e(old('ruang', $jadwalPelajaran->ruang)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="tahun_ajaran"
                                    value="<?php echo e(old('tahun_ajaran', $jadwalPelajaran->tahun_ajaran)); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                                    <?php $__currentLoopData = $semesterList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($semester); ?>"
                                            <?php echo e(old('semester', $jadwalPelajaran->semester) == $semester ? 'selected' : ''); ?>>
                                            <?php echo e($semester); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="aktif"
                                        <?php echo e(old('status', $jadwalPelajaran->status) == 'aktif' ? 'selected' : ''); ?>>
                                        Aktif</option>
                                    <option value="nonaktif"
                                        <?php echo e(old('status', $jadwalPelajaran->status) == 'nonaktif' ? 'selected' : ''); ?>>
                                        Non-Aktif</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Catatan tambahan..."><?php echo e(old('catatan', $jadwalPelajaran->catatan)); ?></textarea>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\jadwal-pelajaran\edit.blade.php ENDPATH**/ ?>