                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content text-center">
                        ...
                        <div class="breadcrumb-links" style="color: #ffffff; opacity: 0.95; font-size: 1rem;">
                            ...
                            <a href="<?php echo e(route('pages.public.index')); ?>" style="color: #ffffff; text-decoration: none; transition: opacity 0.3s;">Halaman</a>
                            <span style="margin: 0 10px; opacity: 0.7;">/</span>
                            <span style="opacity: 0.95; font-weight: 500;"><?php echo e($page->title); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div style="margin-bottom: 2rem;">
                        <a href="<?php echo e(route('pages.public.index')); ?>" style="display: inline-flex; align-items: center; gap: 8px; padding: 10px 24px; background: #ffffff; color: #00529C; border: 2px solid #00529C; border-radius: 8px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.08);"
                                            ...
                                            <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-6 mb-3">
                                                    <div style="padding: 16px; background: #f8f9fa; border-radius: 10px; border: 1px solid #e9ecef;">
                                                        ...
                                                        <p style="margin: 0; font-size: 1rem; color: #333; font-weight: 500;"><?php echo e($value); ?></p>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.telkom', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\telkom\resources\views\pages\public\show.blade.php ENDPATH**/ ?>