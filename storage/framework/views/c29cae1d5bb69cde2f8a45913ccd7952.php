        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-6 lg:px-16 xl:px-20 bg-white">
            <div class="mx-auto w-full max-w-lg bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="mt-2 text-lg text-gray-700">Halo, <?php echo e(auth()->user()->name); ?>!</p>
                </div>
                ...
                <div class="mt-10 text-center">
                    ...
                    <p class="text-gray-600 mb-6">
                        ...
                        <br>
                        <strong class="text-gray-900"><?php echo e(auth()->user()->email); ?></strong>
                    </p>
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="w-full btn btn-outline py-4 text-lg font-medium">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="<?php echo e(route('verification.resend-guest')); ?>"
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\auth\verify-email.blade.php ENDPATH**/ ?>