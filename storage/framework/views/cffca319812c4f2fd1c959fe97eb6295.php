...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl border border-slate-200 p-8">
            <form method="POST" action="<?php echo e(route('admin.sarpras.barang.store')); ?>" enctype="multipart/form-data"
                class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="border-b border-slate-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="nama_barang" name="nama_barang" value="<?php echo e(old('nama_barang')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="kode_barang" name="kode_barang" value="<?php echo e(old('kode_barang')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($kategori->id); ?>"
                                        <?php echo e(old('kategori_id') == $kategori->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $ruangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ruang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ruang->id); ?>"
                                        <?php echo e(old('ruang_id') == $ruang->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="hilang" <?php echo e(old('kondisi') == 'hilang' ? 'selected' : ''); ?>>Hilang
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="tersedia" <?php echo e(old('status') == 'tersedia' ? 'selected' : ''); ?>>Tersedia
                                </option>
                                <option value="dipinjam" <?php echo e(old('status') == 'dipinjam' ? 'selected' : ''); ?>>Dipinjam
                                </option>
                                <option value="rusak" <?php echo e(old('status') == 'rusak' ? 'selected' : ''); ?>>Rusak</option>
                                <option value="hilang" <?php echo e(old('status') == 'hilang' ? 'selected' : ''); ?>>Hilang
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="harga_beli" name="harga_beli" value="<?php echo e(old('harga_beli')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_pembelian" name="tanggal_pembelian"
                                value="<?php echo e(old('tanggal_pembelian')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Masukkan deskripsi barang"><?php echo e(old('deskripsi')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\barang\create.blade.php ENDPATH**/ ?>