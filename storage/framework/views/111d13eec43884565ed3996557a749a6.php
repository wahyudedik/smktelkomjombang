            ...
            <div class="mx-auto w-full max-w-lg bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div class="text-center lg:text-left">
                    <div class="mx-auto lg:mx-0 flex items-center justify-center lg:justify-start">
                        <img src="<?php echo e(asset('assets_telkom/assets/images/logo-dark.png')); ?>" alt="Logo Telkom" style="max-height: 60px;">
                    </div>
                ...
                <div
                    ...
                    <div class="mb-8">
                        <div
                            ...
                            <img src="<?php echo e(asset('assets_telkom/assets/images/logo.png')); ?>" alt="Logo Telkom" style="max-height: 80px;">
                        </div>
                    </div>
