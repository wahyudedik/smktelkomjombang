...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Create Testimonial Link')); ?>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="<?php echo e(route('admin.testimonial-links.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                placeholder="Optional description for this testimonial link"><?php echo e(old('description')); ?></textarea>
                        </div>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    <input type="checkbox" name="target_audience[]" value="Siswa" 
                                        <?php echo e(in_array('Siswa', old('target_audience', [])) ? 'checked' : ''); ?>
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="target_audience[]" value="Guru" 
                                        <?php echo e(in_array('Guru', old('target_audience', [])) ? 'checked' : ''); ?>
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="target_audience[]" value="Alumni" 
                                        <?php echo e(in_array('Alumni', old('target_audience', [])) ? 'checked' : ''); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="datetime-local" name="active_from" id="active_from" 
                                    value="<?php echo e(old('active_from', now()->format('Y-m-d\TH:i'))); ?>" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="active_until" id="active_until" 
                                    value="<?php echo e(old('active_until', now()->addDays(30)->format('Y-m-d\TH:i'))); ?>" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="max_submissions" id="max_submissions" 
                                value="<?php echo e(old('max_submissions')); ?>" min="1"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\admin\testimonial-links\create.blade.php ENDPATH**/ ?>