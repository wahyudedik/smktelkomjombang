     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('common.create_new_page')); ?>
...
unset($__errorArgs, $__bag); ?>">
                                            <option value="draft" <?php echo e(old('status') == 'draft' ? 'selected' : ''); ?>><?php echo e(__('common.draft')); ?>
...
unset($__errorArgs, $__bag); ?>">
                                            <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>"
                                                    <?php echo e(old('template') == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($name); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="category" id="category"
                                            value="<?php echo e(old('category')); ?>" list="categories"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('seo_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div id="menu-settings" class="space-y-4" style="display: none;">
                                        <div>
                                            <label for="menu_title" class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('common.menu_title')); ?></label>
                                        ...
                                        <div>
                                            ...
                                            <select name="menu_position" id="menu_position"
                                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                                <option value="header"
                                                    <?php echo e(old('menu_position') == 'header' ? 'selected' : ''); ?>><?php echo e(__('common.header')); ?></option>
                                                <option value="footer"
                                                    <?php echo e(old('menu_position') == 'footer' ? 'selected' : ''); ?>><?php echo e(__('common.footer')); ?></option>
                                            </select>
                                        </div>

                                        <div>
                                            <label for="parent_id" class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('common.parent_menu')); ?></label>
                                        ...
                                        <div>
                                            <label for="menu_icon" class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('common.menu_icon')); ?></label>
                                        ...
                                        <div>
                                            <label for="menu_url" class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('common.custom_url')); ?></label>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\pages\create.blade.php ENDPATH**/ ?>