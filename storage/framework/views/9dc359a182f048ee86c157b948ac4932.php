...
<div id="rs-contact" class="rs-contact style2 pt-94 pb-100 md-pt-64 md-pb-70" style="background-color: #f8f9fa;">
    <div class="container">
        <div class="sec-title mb-60 text-center">
            <div class="sub-title primary"><i class="fas fa-envelope"></i> <?php echo e($siteSettings['contact_section_subtitle'] ?? 'Hubungi Kami'); ?></div>
            <h2 class="title mb-0"><?php echo e($siteSettings['contact_section_title'] ?? 'Kontak'); ?> <span><?php echo e($siteSettings['site_name'] ?? 'SMK Telekomunikasi'); ?></span></h2>
            <p><?php echo e($siteSettings['contact_section_description'] ?? 'Jangan ragu untuk menghubungi kami jika memiliki pertanyaan'); ?></p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 md-mb-30">
                    ...
                    <div class="contact-widget-list pt-20">
                        <div class="contact-widget-item">
                            ...
                            <div class="content-part">
                                ...
                                <p><?php echo e($siteSettings['contact_address'] ?? 'Ponpes Darul Ulum, Jl. Wahid Hasyim No.128, Kedunglosari, Kedungrejo, Kec. Bandar Kedungmulyo, Kabupaten Jombang, Jawa Timur 61462'); ?></p>
                            </div>
                        </div>
                        <div class="contact-widget-item">
                            <div class="icon-part">
                        ...
                        <div class="contact-widget-item">
                            ...
                            <div class="content-part">
                                ...
                                <p><a href="mailto:<?php echo e($siteSettings['contact_email'] ?? 'smktelkomdujbg@gmail.com'); ?>"><?php echo e($siteSettings['contact_email'] ?? 'smktelkomdujbg@gmail.com'); ?></a></p>
                            </div>
                        </div>
                        <div class="contact-widget-item">
                            <div class="icon-part">
                            ...
                            <div class="content-part">
                                ...
                                <p><?php echo e($siteSettings['contact_operational_hours'] ?? 'Senin - Sabtu: 07.00 - 16.00 WIB'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6 mb-20">
                        <a href="<?php echo e($siteSettings['social_whatsapp'] ?? 'https://wa.me/6285649400339'); ?>" target="_blank" class="readon2" style="width: 100%; text-align: center; background-color: #25D366; border-color: #25D366;">
                            <i class="fab fa-whatsapp"></i> WhatsApp
                        </a>
                    </div>
                    <div class="col-sm-6 mb-20">
                        <a href="mailto:<?php echo e($siteSettings['contact_email'] ?? 'smktelkomdujbg@gmail.com'); ?>" class="readon2" style="width: 100%; text-align: center;">
            ...
            <div class="col-lg-7">
                ...
                <div class="contact-map mb-30" style="border-radius: 8px; overflow: hidden; box-shadow: 0 5px 30px rgba(0,0,0,0.1);">
                    <iframe
                        src="<?php echo e($siteSettings['contact_map_url'] ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.8547!2d112.2327!3d-7.5469!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7e2c1e8e8e8e9%3A0x1234567890abcdef!2sSMK%20Telekomunikasi%20Darul%20Ulum!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid'); ?>"
                        width="100%"
                        height="300"
...
function handleContactSubmit(e) {
    ...
    if (submitter && submitter.id === 'btnEmail') {
        ...
        window.location.href = 'mailto:<?php echo e($siteSettings["contact_email"] ?? "smktelkomdujbg@gmail.com"); ?>?subject=' + mailtoSubject + '&body=' + mailtoBody;
    } else {
        ...
        window.location.href = '<?php echo e($siteSettings["social_whatsapp"] ?? "https://wa.me/6285649400339"); ?>?text=' + waMessage;
    }
    return false;
}
</script>
<!-- Contact Section End -->
<?php /**PATH E:\PROJEKU\telkom\resources\views/components/telkom/contact.blade.php ENDPATH**/ ?>