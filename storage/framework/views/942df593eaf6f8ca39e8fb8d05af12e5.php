...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.maudu.breadcrumb','data' => ['title' => 'Semua Halaman','items' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Semua Halaman','items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
        ['label' => 'Home', 'url' => route('landing')],
        ['label' => 'Halaman', 'url' => route('pages.public.index')],
    ])]); ?>
...
<?php echo $__env->make('layouts.maudu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\telkom\resources\views\pages\public\index-maudu.blade.php ENDPATH**/ ?>