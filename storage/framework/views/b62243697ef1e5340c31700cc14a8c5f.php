...
<div class="relative" x-data="{ open: false }">
    <button @click="open = !open"
        ...
        <span><?php echo e($availableLocales[$currentLocale]['flag'] ?? '🌐'); ?></span>
    ...
    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100"
        ...
        class="absolute <?php echo e(function_exists('is_rtl') && is_rtl() ? 'left-0' : 'right-0'); ?> mt-2 w-48 bg-white rounded-lg shadow-lg z-50 border border-slate-200">
        <div class="py-1">
...
<?php /**PATH E:\PROJEKU\telkom\resources\views\components\language-switcher.blade.php ENDPATH**/ ?>