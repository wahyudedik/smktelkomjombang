                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm">
                        <div class="position-relative">
                            <img src="<?php echo e($post['media_url'] ?? asset('assets/img/portfolio/01.jpg')); ?>"
                        ...
                        <div class="card-body d-flex flex-column">
                            <p class="card-text flex-grow-1">
                                <?php echo e(Str::limit($post['caption'] ?? 'Kegiatan Sekolah', 150)); ?>
        ...
        <?php if(!empty($posts) && count($posts) > 0): ?>
            <div class="row mt-4">
                <div class="col-12 text-center">
                    <a href="<?php echo e(route('public.kegiatan')); ?>" class="theme-btn">
...
<?php /**PATH E:\PROJEKU\ig-to-web\resources\views/components/landing/gallery.blade.php ENDPATH**/ ?>