...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.breadcrumb','data' => ['title' => Auth::user()->hasRole('superadmin') ? __('common.superadmin_dashboard') : (Auth::user()->hasRole('admin') ? __('common.admin_dashboard') : __('common.dashboard')),'items' => [
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Auth::user()->hasRole('superadmin') ? __('common.superadmin_dashboard') : (Auth::user()->hasRole('admin') ? __('common.admin_dashboard') : __('common.dashboard'))),'items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                    ['label' => __('common.dashboard'), 'url' => route('admin.dashboard')],
                ])]); ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-2">
                    <div>
                        <p class="text-slate-600 dark:text-dark-300"><?php echo e(__('common.welcome_back')); ?>, <?php echo e(Auth::user()->name); ?>!</p>
                    </div>
    ...
    <div class="py-6" x-data="dashboardStats()">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
                ...
                <?php if(Auth::user()->hasRole('siswa')): ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div>
                                <p class="text-sm font-medium text-slate-600"><?php echo e(__('common.profile_status')); ?></p>
                                <p class="text-2xl font-bold text-green-600"><?php echo e(__('common.complete')); ?></p>
                                <p class="text-xs text-slate-500 mt-1"><?php echo e(__('common.profile_complete')); ?></p>
                            </div>
                            <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                                <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div>
                                <p class="text-sm font-medium text-slate-600"><?php echo e(__('common.academic_progress')); ?></p>
                                <p class="text-2xl font-bold text-blue-600">85%</p>
                                <p class="text-xs text-slate-500 mt-1"><?php echo e(__('common.learning_progress')); ?></p>
                            </div>
                            <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                                <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div>
                                <p class="text-sm font-medium text-slate-600"><?php echo e(__('common.upcoming_events')); ?></p>
                                <p class="text-2xl font-bold text-purple-600">3</p>
                                <p class="text-xs text-slate-500 mt-1"><?php echo e(__('common.upcoming_events')); ?></p>
                            </div>
                            <div class="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                                <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-8" x-data x-init="$nextTick(() => initCharts())">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-white">
                                    <?php echo e(__('common.user_growth')); ?></h3>
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-2">
                            <?php echo e(__('common.module_usage')); ?></h3>
                                ...
                                <?php $__currentLoopData = $moduleUsage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduleName => $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center">
                                            <span
                                                class="w-3 h-3 rounded-full mr-2 bg-<?php echo e($module['color']); ?>-500"></span>
                                            <span class="text-slate-600 dark:text-dark-300"><?php echo e($moduleName); ?></span>
                                        </div>
                                        <span
                                            class="font-medium text-slate-900 dark:text-white"><?php echo e($module['percentage']); ?>%</span>
                                    </div>
                    ...
                    <div class="lg:col-span-1" x-data="{ expanded: true }">
                        <div
                            ...
                            <div class="flex items-center justify-between mb-4 cursor-pointer"
                                ...
                                <h3 class="text-lg font-semibold text-slate-900 dark:text-white">
                                    <?php echo e(__('common.quick_actions')); ?></h3>
                            ...
                            <div class="space-y-3" x-show="expanded" x-collapse>
                                <?php if(Auth::user()->hasRole('superadmin') || Auth::user()->can('users.create')): ?>
                                    <a href="<?php echo e(route('admin.superadmin.users.create')); ?>"
                                        ...
                                        <span
                                            class="text-sm font-medium text-slate-900 dark:text-white"><?php echo e(__('common.add_new_user')); ?></span>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if(Auth::user()->hasRole('superadmin') || Auth::user()->can('guru.create')): ?>
                                    <a href="<?php echo e(route('admin.guru.create')); ?>"
                                        ...
                                        <span
                                            class="text-sm font-medium text-slate-900 dark:text-white"><?php echo e(__('common.add_new_teacher')); ?></span>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if(Auth::user()->hasRole('superadmin') || Auth::user()->can('siswa.create')): ?>
                                    <a href="<?php echo e(route('admin.siswa.create')); ?>"
                                        ...
                                        <span
                                            class="text-sm font-medium text-slate-900 dark:text-white"><?php echo e(__('common.add_new_student')); ?></span>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if(Auth::user()->hasRole('superadmin') || Auth::user()->hasRole('sarpras') || Auth::user()->can('sarpras.create')): ?>
                                    <a href="<?php echo e(route('admin.sarpras.barang.create')); ?>"
                                        ...
                                        <span
                                            class="text-sm font-medium text-slate-900 dark:text-white"><?php echo e(__('common.add_new_asset')); ?></span>
                                    </a>
                                <?php endif; ?>
                        ...
                        <div
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                                <div class="flex items-center gap-3 cursor-pointer" @click="expanded = !expanded">
                                    <h3 class="text-lg font-semibold text-slate-900 dark:text-white">
                                        <?php echo e(__('common.recent_activity')); ?></h3>
                                    <svg class="w-5 h-5 text-slate-400 transition-transform duration-200"
                                        :class="{ 'rotate-180': !expanded }" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="space-y-3" x-show="expanded" x-collapse>
                                <?php $__empty_1 = true; $__currentLoopData = $recentActivities ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php if($activity): ?>
                                        ...
                                        ?>
                                        <div x-show="searchQuery === '' || '<?php echo e(strtolower($activity->action ?? '')); ?>'.includes(searchQuery.toLowerCase()) || '<?php echo e(strtolower($activity->user->name ?? 'system')); ?>'.includes(searchQuery.toLowerCase()) || '<?php echo e(strtolower($activity->description ?? '')); ?>'.includes(searchQuery.toLowerCase())"
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 flex-wrap">
                                                    <?php if($activity->user): ?>
                                                        <span
                                                            class="text-sm font-medium text-slate-900 dark:text-white"><?php echo e($activity->user->name); ?></span>
                                                    <?php else: ?>
                                                        <span
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <div class="text-center py-8">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-slate-900">
                                            <?php echo e(__('common.no_recent_activity')); ?></h3>
        ...
        <?php if(Auth::user()->hasRole('siswa')): ?>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <h3 class="text-lg font-semibold text-slate-900 mb-4"><?php echo e(__('common.student_profile')); ?></h3>
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4">
                            <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
                                <span
                                    class="text-2xl font-bold text-blue-600"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                            </div>
                            <div>
                                <h4 class="text-lg font-semibold text-slate-900"><?php echo e(Auth::user()->name); ?></h4>
                                <p class="text-sm text-slate-600"><?php echo e(Auth::user()->email); ?></p>
                                <span
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-200">
                            ...
                            <div>
                                <p class="text-sm text-slate-500"><?php echo e(__('common.tahun_ajaran')); ?></p>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <h3 class="text-lg font-semibold text-slate-900 mb-4"><?php echo e(__('common.academic_info')); ?></h3>
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500"><?php echo e(__('common.this_month')); ?></p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-slate-900"><?php echo e(__('common.upcoming_exams')); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Upcoming Events -->
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <h3 class="text-lg font-semibold text-slate-900 mb-4"><?php echo e(__('common.upcoming_events')); ?></h3>
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-slate-900"><?php echo e(__('common.parent_meeting')); ?></p>
                        ...
                        <div class="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-slate-900"><?php echo e(__('common.science_fair')); ?></p>
                ...
                <!-- Quick Links -->
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                    <h3 class="text-lg font-semibold text-slate-900 mb-4"><?php echo e(__('common.quick_access')); ?></h3>
                    <div class="space-y-3">
                        <a href="#"
                            ...
                            <span class="text-sm font-medium text-slate-900"><?php echo e(__('common.view_grades')); ?></span>
                        </a>
                        ...
                        <a href="#"
                            ...
                            <span class="text-sm font-medium text-slate-900"><?php echo e(__('common.download_report')); ?></span>
                        </a>
                        ...
                        <a href="#"
                            ...
                            <span class="text-sm font-medium text-slate-900"><?php echo e(__('common.schedule')); ?></span>
                        </a>
                        ...
                        <a href="#"
                            ...
                            <span class="text-sm font-medium text-slate-900"><?php echo e(__('common.classmates')); ?></span>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            function dashboardStats() {
                return {
                    stats: {
                        siswa: <?php echo e($statistics['total_siswa'] ?? 0); ?>,
                        guru: <?php echo e($statistics['total_guru'] ?? 0); ?>,
                        users: <?php echo e($statistics['total_users'] ?? 0); ?>,
                        barang: <?php echo e($statistics['total_barang'] ?? 0); ?>,
                        siswaTrend: null,
                        guruTrend: null,
                    },
                    pollInterval: null,
                    ...
                    async fetchStats() {
                        try {
                            const response = await fetch('<?php echo e(route('admin.dashboard.api.stats')); ?>', {
                                headers: {
            ...
            function initCharts() {
                ...
                if (growthCtx) {
                    new Chart(growthCtx.getContext('2d'), {
                        type: 'bar',
                        data: {
                            labels: <?php echo json_encode(array_column($userGrowth['data'], 'month')); ?>,
                            datasets: [{
                                    label: 'Siswa',
                                    data: <?php echo json_encode(array_map(fn($d) => $d['siswa']['count'], $userGrowth['data'])); ?>,
                                ...
                                {
                                    label: 'Guru',
                                    data: <?php echo json_encode(array_map(fn($d) => $d['guru']['count'], $userGrowth['data'])); ?>,
                ...
                if (moduleCtx) {
                    ...
                    const moduleValues = <?php echo json_encode($moduleValues); ?>;
                    ...
                    new Chart(moduleCtx.getContext('2d'), {
                        type: 'doughnut',
                        data: {
                            labels: <?php echo json_encode($moduleLabels); ?>,
                            datasets: [{
                                data: moduleValues,
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views/dashboards/admin.blade.php ENDPATH**/ ?>