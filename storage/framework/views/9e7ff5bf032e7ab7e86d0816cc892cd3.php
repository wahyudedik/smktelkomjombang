            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900">
                    <?php if(Auth::user()->hasRole('superadmin')): ?>
                        <?php echo e(__('common.superadmin_dashboard')); ?>

                    <?php elseif(Auth::user()->hasRole('admin')): ?>
                        <?php echo e(__('common.admin_dashboard')); ?>

                    <?php elseif(Auth::user()->hasRole('guru')): ?>
                        <?php echo e(__('common.guru_dashboard')); ?>

                    <?php elseif(Auth::user()->hasRole('siswa')): ?>
                        <?php echo e(__('common.siswa_dashboard')); ?>

                    <?php elseif(Auth::user()->hasRole('sarpras')): ?>
                        <?php echo e(__('common.sarpras_dashboard')); ?>
                ...
                <p class="text-slate-600 mt-1"><?php echo e(__('common.welcome_back')); ?>, <?php echo e(Auth::user()->name); ?>!</p>
            </div>
