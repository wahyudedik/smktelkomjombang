            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <?php if(Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin'])): ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-slate-600"><?php echo e(__('common.total_siswa')); ?></p>
                ...
                <?php if(Auth::user()->hasAnyRole(['guru', 'admin', 'superadmin'])): ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-slate-600"><?php echo e(__('common.total_guru')); ?></p>
                ...
                <?php if(Auth::user()->hasAnyRole(['admin', 'superadmin'])): ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-slate-600"><?php echo e(__('common.active_users')); ?></p>
                ...
                <?php if(Auth::user()->hasAnyRole(['sarpras', 'admin', 'superadmin'])): ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-slate-600"><?php echo e(__('common.total_assets')); ?></p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-slate-900"><?php echo e(__('common.user_growth')); ?></h3>
                    ...
                    <!-- Module Usage Chart -->
                    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        <h3 class="text-lg font-semibold text-slate-900 mb-4"><?php echo e(__('common.module_usage')); ?></h3>
                            ...
                            <?php $__currentLoopData = $moduleUsage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moduleName => $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-xs text-slate-400 ml-2">(<?php echo e($module['data_count']); ?>
            ...
            <?php if(Auth::user()->hasAnyRole(['admin', 'superadmin'])): ?>
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-3">
                                <?php if(Auth::user()->hasRole('superadmin') || Auth::user()->can('users.create')): ?>
                                    <a href="<?php echo e(route('admin.superadmin.users.create')); ?>"
                                        ...
                                        <span class="text-sm font-medium text-slate-900"><?php echo e(__('common.add_new_user')); ?></span>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if(Auth::user()->hasRole('superadmin') || Auth::user()->can('guru.create')): ?>
                                    <a href="<?php echo e(route('admin.guru.create')); ?>"
                                        ...
                                        <span class="text-sm font-medium text-slate-900"><?php echo e(__('common.add_new_teacher')); ?></span>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if(Auth::user()->hasRole('superadmin') || Auth::user()->can('siswa.create')): ?>
                                    <a href="<?php echo e(route('admin.siswa.create')); ?>"
                                        ...
                                        <span class="text-sm font-medium text-slate-900"><?php echo e(__('common.add_new_student')); ?></span>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if(Auth::user()->hasRole('superadmin') || Auth::user()->hasRole('sarpras') || Auth::user()->can('sarpras.create')): ?>
                                    <a href="<?php echo e(route('admin.sarpras.barang.create')); ?>"
                                        ...
                                        <span class="text-sm font-medium text-slate-900"><?php echo e(__('common.add_new_asset')); ?></span>
                                    </a>
                                <?php endif; ?>
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-slate-900"><?php echo e(__('common.recent_activity')); ?></h3>
                            ...
                            <div class="space-y-3">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <div class="text-center py-8">
                                        ...
                                        <h3 class="mt-2 text-sm font-medium text-slate-900"><?php echo e(__('common.no_recent_activity')); ?></h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-slate-900"><?php echo e(__('common.upcoming_exams')); ?></p>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\ig-to-web\resources\views/dashboards/admin.blade.php ENDPATH**/ ?>