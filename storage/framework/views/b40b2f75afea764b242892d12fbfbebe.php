                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="<?php echo e(route('admin.roles.sync-users', $role)); ?>" method="POST" id="assignUsersForm">
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="<?php echo e(route('admin.role-permissions.index')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\role-management\assign-users.blade.php ENDPATH**/ ?>