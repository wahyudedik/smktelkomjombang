                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <?php if(cache('site_setting_about_image_1')): ?>
                                    <img class="img-1" src="<?php echo e(Storage::url(cache('site_setting_about_image_1'))); ?>"
                                        alt="About Image 1">
                                <?php else: ?>
                                    <img class="img-1" src="<?php echo e(asset('assets/img/about/01.jpg')); ?>" alt="">
                                <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <?php if(cache('site_setting_about_image_2')): ?>
                                    <img class="img-2" src="<?php echo e(Storage::url(cache('site_setting_about_image_2'))); ?>"
                                        alt="About Image 2">
                                <?php else: ?>
                                    <img class="img-2" src="<?php echo e(asset('assets/img/about/02.jpg')); ?>" alt="">
                                <?php endif; ?>
                                <?php if(cache('site_setting_about_image_3')): ?>
                                    <img class="img-3 mt-4"
                                        ...
                                        alt="About Image 3">
                                <?php else: ?>
                                    <img class="img-3 mt-4" src="<?php echo e(asset('assets/img/about/03.jpg')); ?>" alt="">
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="about-content">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about-item">
                                    <div class="about-item-icon">
                                        <img src="<?php echo e(asset('assets/img/icon/information.svg')); ?>" alt="">
                                    </div>
                                ...
                                <div class="about-item">
                                    <div class="about-item-icon">
                                        <img src="<?php echo e(asset('assets/img/icon/global-education.svg')); ?>" alt="">
                                    </div>
                                    <div class="about-item-content">
                            ...
                            <div class="col-md-6">
                                <div class="about-item">
                                    <div class="about-item-icon">
                                        <img src="<?php echo e(asset('assets/img/icon/open-book.svg')); ?>" alt="">
                                    </div>
                                    <div class="about-item-content">
                                ...
                                <div class="about-item">
                                    <div class="about-item-icon">
                                        <img src="<?php echo e(asset('assets/img/icon/location.svg')); ?>" alt="">
                                    </div>
                                    <div class="about-item-content">
...
<!-- about area end -->
<?php /**PATH E:\PROJEKU\ig-to-web\resources\views/components/landing/about.blade.php ENDPATH**/ ?>