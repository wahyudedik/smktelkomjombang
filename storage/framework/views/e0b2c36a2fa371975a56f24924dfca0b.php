...
<body>
    <div class="header">
        ...
        <p>Tanggal: <strong><?php echo e(\Carbon\Carbon::parse($date)->format('d F Y')); ?></strong></p>
    </div>
    ...
    <div class="stats">
        ...
        <div class="stat-box">
            ...
            <div class="value green"><?php echo e($stats['present']); ?></div>
        </div>
        <div class="stat-box">
            <div class="label">Tidak Hadir</div>
            <div class="value red"><?php echo e($stats['absent']); ?></div>
        </div>
    </div>
...
<?php /**PATH E:\PROJEKU\telkom\resources\views\attendance\pdf\daily.blade.php ENDPATH**/ ?>