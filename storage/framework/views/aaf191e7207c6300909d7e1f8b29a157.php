                ...
                <a class="navbar-brand" href="/">
                    <?php if(cache('site_setting_logo')): ?>
                        <img src="<?php echo e(Storage::url(cache('site_setting_logo'))); ?>"
                            alt="<?php echo e(cache('site_setting_site_name', 'SMK Telekomunikasi')); ?>" style="max-height: 50px;">
                    <?php else: ?>
                        <img src="<?php echo e(theme_image('logo', theme_info('defaults.logo', 'assets_telkom/assets/images/logo.png'))); ?>" alt="<?php echo e(theme_info('name', config('app.name'))); ?>">
                    <?php endif; ?>
                </a>
...
<!-- popup search end -->
<?php /**PATH E:\PROJEKU\telkom\resources\views\components\landing\header.blade.php ENDPATH**/ ?>