        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-6 lg:px-16 xl:px-20 bg-white">
            <div class="mx-auto w-full max-w-lg bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <h2 class="mt-6 text-4xl font-bold text-gray-900">Lupa Password?</h2>
                    <p class="mt-2 text-lg text-gray-700">Masukkan email Anda untuk mendapatkan link reset password</p>
                </div>
        ...
        <div class="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:px-8">
            <div class="relative h-full">
                ...
                <div
                    ...
                    <!-- Welcome Text -->
                    <h1 class="text-4xl lg:text-5xl font-bold mb-6 text-white drop-shadow-lg">Reset Password</h1>
                    <p class="text-xl lg:text-2xl text-white mb-10 max-w-md lg:max-w-lg drop-shadow-md">
                        Jangan khawatir, kami akan membantu Anda mendapatkan akses kembali ke akun Anda
                    </p>
                    ...
                    <div class="space-y-4 text-left max-w-sm lg:max-w-md">
                        <div class="flex items-center">
                            ...
                            <span class="text-white drop-shadow-sm text-lg">Link reset aman dan terenkripsi</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-green-300 mr-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-white drop-shadow-sm text-lg">Link berlaku dalam 24 jam</span>
                        </div>
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-green-300 mr-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>