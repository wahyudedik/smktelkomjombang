...
<head>
    ...
    <?php else: ?>
        <link rel="apple-touch-icon" href="<?php echo e(asset('assets_telkom/assets/images/logo-dark.png')); ?>">
    <?php endif; ?>
...
<?php /**PATH E:\PROJEKU\telkom\resources\views/layouts/guest.blade.php ENDPATH**/ ?>