...
<?php $component->withAttributes([]); ?>
    ...
    <script>
        ...
        document.getElementById('createRoleForm').addEventListener('submit', function(e) {
            ...
            const existingRoles = <?php echo json_encode($roles->pluck('name'), 15, 512) ?>;
        ...
        function editRole(roleId) {
            ...
            const coreRoles = <?php echo json_encode(get_core_roles(), 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\admin\role-permissions\index.blade.php ENDPATH**/ ?>