     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                ...
                <p class="text-slate-600 mt-1">Perbarui data kegiatan: <strong><?php echo e($event->title); ?></strong></p>
            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="category" value="<?php echo e(old('category', $event->category)); ?>"
                                list="category-list"
...
unset($__errorArgs, $__bag); ?>">
                            <option value="active" <?php echo e(old('status', $event->status) === 'active' ? 'selected' : ''); ?>>Aktif (tampil di landing page)</option>
                            <option value="inactive" <?php echo e(old('status', $event->status) === 'inactive' ? 'selected' : ''); ?>>Nonaktif</option>
                            <option value="archived" <?php echo e(old('status', $event->status) === 'archived' ? 'selected' : ''); ?>>Arsip</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <p class="text-xs text-slate-500 mt-1">Kosongkan jika tidak ingin mengubah gambar. Format: JPG, PNG, GIF, WEBP. Maks 2MB.</p>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\events\edit.blade.php ENDPATH**/ ?>