     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Import Data Barang Sarpras')); ?>
                ...
                <div class="p-6 text-gray-900">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <form action="<?php echo e(route('admin.sarpras.barang.processImport')); ?>" method="POST"
                        ...
                        <div>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                ...
                                <ul class="text-sm text-blue-800 space-y-1">
                                    ...
                                    <li>• Kategori dan Ruang harus sudah ada di sistem</li>
                                    <li>• Kondisi: baik, rusak, hilang</li>
                                    <li>• Status: aktif, tidak_aktif, maintenance</li>
                                    <li>• Format tanggal: YYYY-MM-DD</li>
                                    <li>• Harga dalam format angka (tanpa koma)</li>
                                </ul>
                            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Lab Komputer</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">5</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">baik</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">aktif</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">8000000</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\barang\import.blade.php ENDPATH**/ ?>