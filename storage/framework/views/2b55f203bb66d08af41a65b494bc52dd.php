...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="welcome">Welcome, <?php echo e($user->name); ?>!</div>
        ...
        <div class="content">
            ...
            <p>You have been invited to join <strong>Portal Sekolah</strong> as a <span
                    class="role-badge"><?php echo e($user->roles->first() ? ucfirst($user->roles->first()->name) : 'User'); ?></span>.</p>
            ...
            <div class="credentials">
                ...
                <div class="credential-item">
                    ...
                    <span class="credential-value"><?php echo e($tempPassword); ?></span>
                </div>
                <div class="credential-item">
                    <span class="credential-label">Role:</span>
                    <span class="credential-value"><?php echo e($user->roles->first() ? ucfirst($user->roles->first()->name) : 'No Role'); ?></span>
                </div>
            </div>

            <div style="text-align: center;">
                <a href="<?php echo e($loginUrl); ?>" class="button">Login to Portal</a>
            </div>
        ...
        <div class="footer">
            ...
            <p>© <?php echo e(date('Y')); ?> Portal Sekolah. All rights reserved. wahyu dedik developer</p>
...
<?php /**PATH E:\PROJEKU\telkom\resources\views\emails\user-invitation.blade.php ENDPATH**/ ?>