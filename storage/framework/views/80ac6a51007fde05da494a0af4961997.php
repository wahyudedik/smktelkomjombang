                ...
                <div class="row rs-counter couter-area mb-40">
                    <div class="col-md-4">
                        <div class="counter-item one">
                            <h2 class="number"><?php echo e($siteSettings['counter1_number'] ?? ($siswaCount > 0 ? $siswaCount . '+' : '400+')); ?></h2>
                            <h4 class="title mb-0"><?php echo e($siteSettings['counter1_label'] ?? 'Siswa'); ?></h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="counter-item two">
                            <h2 class="number"><?php echo e($siteSettings['counter2_number'] ?? '4'); ?></h2>
                            <h4 class="title mb-0"><?php echo e($siteSettings['counter2_label'] ?? 'Jurusan'); ?></h4>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="counter-item three">
                            <h2 class="number"><?php echo e($siteSettings['counter3_number'] ?? ($kelulusanPercentage > 0 ? $kelulusanPercentage : '90')); ?><?php echo e($siteSettings['counter3_label'] == 'Lanjut Kuliah' ? '%' : ''); ?></h2>
                            <h4 class="title mb-0"><?php echo e($siteSettings['counter3_label'] ?? 'Lanjut Kuliah'); ?></h4>
                        </div>
                    </div>
                </div>
