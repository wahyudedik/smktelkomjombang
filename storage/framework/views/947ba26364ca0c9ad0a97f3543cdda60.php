...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <!-- Total Sarana -->
            <div class="card <?php echo e($stats['sarana_perlu_update'] > 0 ? 'border-l-4 border-yellow-500' : ''); ?>">
                <div class="card-body">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center relative">
                                    ...
                                    <?php if($stats['sarana_perlu_update'] > 0): ?>
                                    <span class="absolute -top-1 -right-1 bg-yellow-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                                        <?php echo e($stats['sarana_perlu_update']); ?>
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-yellow-600 mt-1">
                                    <?php echo e($stats['sarana_perlu_update']); ?> perlu update
                                </p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <a href="<?php echo e(route('admin.sarpras.sarana.index')); ?>" 
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-emerald-600">
                                Rp <?php echo e(number_format($stats['total_sarana_nilai'], 0, ',', '.')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <!-- Damaged Items -->
            <div class="card <?php echo e($stats['barang_rusak_perlu_maintenance'] > 0 ? 'border-l-4 border-red-500' : ''); ?>">
                <div class="card-body">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div class="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center relative">
                                ...
                                <?php if($stats['barang_rusak_perlu_maintenance'] > 0): ?>
                                <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                                    <?php echo e($stats['barang_rusak_perlu_maintenance']); ?>
                        ...
                        <div class="ml-4 flex-1">
                            ...
                            <p class="text-xs text-red-600 mt-1">
                                <?php echo e($stats['barang_rusak_perlu_maintenance']); ?> perlu maintenance
                            </p>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <?php if($stats['barang_rusak_perlu_maintenance'] > 0 || $stats['sarana_perlu_update'] > 0 || $stats['barang_rusak_di_sarana'] > 0): ?>
        <div class="mb-8">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 flex-1">
                            ...
                            <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="font-medium text-slate-900">
                                                <?php echo e($stats['barang_rusak_perlu_maintenance']); ?> Barang Rusak Perlu Maintenance
                                            </p>
                                            <p class="text-sm text-slate-600">Barang dengan kondisi rusak yang belum memiliki maintenance aktif</p>
                                        </div>
                                    </div>
                                    <a href="<?php echo e(route('admin.sarpras.barang.index', ['kondisi' => 'rusak'])); ?>" 
                                ...
                                <?php if($stats['barang_rusak_di_sarana'] > 0): ?>
                                <div class="flex items-center justify-between p-3 bg-white rounded-lg border border-yellow-200">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="font-medium text-slate-900">
                                                <?php echo e($stats['barang_rusak_di_sarana']); ?> Barang Rusak di Sarana
                                            </p>
                                ...
                                <div class="flex items-center justify-between p-3 bg-white rounded-lg border border-yellow-200">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="font-medium text-slate-900">
                                                <?php echo e($stats['sarana_perlu_update']); ?> Sarana Perlu Update
                                            </p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <a href="<?php echo e(route('admin.sarpras.sarana.index')); ?>" class="btn btn-primary">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if($recent_sarana->count() > 0): ?>
                        <div class="space-y-4">
                            <?php $__currentLoopData = $recent_sarana; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sarana): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="flex items-center space-x-2 mt-1">
                                                <p class="text-xs text-slate-500">
                                                    <?php echo e($sarana->ruang->nama_ruang ?? '-'); ?>
                                                ...
                                                <span class="text-slate-300">•</span>
                                                <p class="text-xs text-slate-500">
                                                    <?php echo e($sarana->created_at->diffForHumans()); ?>
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <a href="<?php echo e(route('admin.sarpras.sarana.create')); ?>" 
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\dashboard.blade.php ENDPATH**/ ?>