     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('admin.sarpras.maintenance.edit', $maintenance)); ?>" class="btn btn-secondary">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                    ...
                    <div class="card-body">
                        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-slate-900">#<?php echo e($maintenance->id); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Status</dt>
                                <dd class="mt-1">
                                    <span class="badge badge-<?php echo e($maintenance->status_badge_color); ?>">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-slate-900"><?php echo e($maintenance->item_type_display); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Item Name</dt>
                                <dd class="mt-1 text-sm text-slate-900"><?php echo e($maintenance->item_name); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Maintenance Type</dt>
                                <dd class="mt-1 text-sm text-slate-900"><?php echo e(ucfirst($maintenance->jenis_maintenance)); ?>

                                </dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Technician</dt>
                                <dd class="mt-1 text-sm text-slate-900"><?php echo e($maintenance->teknisi ?? 'N/A'); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Cost</dt>
                                <dd class="mt-1 text-sm text-slate-900"><?php echo e($maintenance->formatted_biaya); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Maintenance Date</dt>
                                <dd class="mt-1 text-sm text-slate-900">
                                    <?php echo e($maintenance->tanggal_maintenance->format('d M Y')); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Completion Date</dt>
                                <dd class="mt-1 text-sm text-slate-900">
                                    <?php echo e($maintenance->tanggal_selesai ? $maintenance->tanggal_selesai->format('d M Y') : 'Not completed'); ?>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <dd class="mt-1 text-sm text-slate-900">
                                    <?php echo e($maintenance->deskripsi_masalah ?? 'No description provided'); ?></dd>
                            </div>
                            <div class="sm:col-span-2">
                                <dt class="text-sm font-medium text-slate-500">Repair Action</dt>
                                <dd class="mt-1 text-sm text-slate-900">
                                    <?php echo e($maintenance->tindakan_perbaikan ?? 'No repair action provided'); ?></dd>
                            </div>
                            <div class="sm:col-span-2">
                                <dt class="text-sm font-medium text-slate-500">Notes</dt>
                                <dd class="mt-1 text-sm text-slate-900">
                                    <?php echo e($maintenance->catatan ?? 'No notes provided'); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <!-- Photos -->
                <?php if($maintenance->photos && count($maintenance->photos) > 0): ?>
                    <div class="card mt-6">
                        <div class="card-header">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                                <?php $__currentLoopData = $maintenance->photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative group">
                                        <img src="<?php echo e($maintenance->getPhotoUrl($photo)); ?>" alt="Maintenance photo"
            ...
            <div class="space-y-6">
                    ...
                    <div class="card-body">
                        <dl class="space-y-4">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-slate-900"><?php echo e($maintenance->user->name ?? 'Unknown'); ?>
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-slate-900">
                                    <?php echo e($maintenance->created_at->format('M d, Y H:i')); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Updated At</dt>
                                <dd class="mt-1 text-sm text-slate-900">
                                    <?php echo e($maintenance->updated_at->format('M d, Y H:i')); ?></dd>
                            </div>
                            <?php if($maintenance->scheduled_date): ?>
                                <div>
                                    <dt class="text-sm font-medium text-slate-500">Scheduled Date</dt>
                                    <dd class="mt-1 text-sm text-slate-900">
                                        <?php echo e($maintenance->scheduled_date->format('M d, Y')); ?></dd>
                                </div>
                            <?php endif; ?>
                            <?php if($maintenance->completed_date): ?>
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-slate-900">
                                        <?php echo e($maintenance->completed_date->format('M d, Y')); ?></dd>
                                </div>
                            <?php endif; ?>
                        </dl>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="space-y-3">
                            <a href="<?php echo e(route('admin.sarpras.maintenance.edit', $maintenance)); ?>"
                            ...
                            <form method="POST"
                                action="<?php echo e(route('admin.sarpras.maintenance.destroy', $maintenance)); ?>"
                                data-confirm="Apakah Anda yakin ingin menghapus maintenance <?php echo e($maintenance->jenis_maintenance); ?>?">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\sarpras\maintenance\show.blade.php ENDPATH**/ ?>