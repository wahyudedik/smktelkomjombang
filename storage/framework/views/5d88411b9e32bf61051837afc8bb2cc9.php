                            ...
                            <div class="space-y-3 max-h-64 overflow-y-auto">
                                <?php $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <span class="text-sm font-medium text-gray-900"><?php echo e($k->nama); ?></span>
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                                ...
                                <span class="bg-green-100 text-green-800 text-sm font-medium px-2.5 py-0.5 rounded">
                                    <?php echo e($jurusan->count()); ?> Total
                                </span>
                            </div>
                            ...
                            <div class="space-y-3 max-h-64 overflow-y-auto">
                                <?php $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <span class="text-sm font-medium text-gray-900"><?php echo e($j->nama); ?></span>
                                        <div class="flex space-x-2">
                                            <button class="text-yellow-600 hover:text-yellow-800 text-sm p-1">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\settings\kelas-jurusan.blade.php ENDPATH**/ ?>