                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-8">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div>
                                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('common.data_management')); ?></h1>
                                <p class="text-gray-600 mt-2"><?php echo e(__('common.manage_data_description')); ?></p>
                            </div>
                            <a href="<?php echo e(route('admin.settings.index')); ?>"
                                class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm font-medium">
                                <i class="fas fa-arrow-left mr-2"></i><?php echo e(__('common.back')); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="bg-purple-50 border border-purple-200 rounded-lg p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-purple-600"><?php echo e(__('common.total_ekstrakurikuler')); ?></p>
                    ...
                    <div id="content-kelas" class="tab-content">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
                            ...
                            <button onclick="openModal('kelas')"
                                ...
                                <i class="fas fa-plus mr-2"></i><?php echo e(__('common.add_kelas')); ?>
                                    ...
                                    <li class="px-6 py-4">
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                            ...
                                            <div class="flex space-x-2">
                                                <button
                                                    onclick="editItem('kelas', <?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>, <?php echo e(json_encode($item->deskripsi ?? '')); ?>)"
                                                    class="text-blue-600 hover:text-blue-900 text-sm font-medium">
                                                    <i class="fas fa-edit mr-1"></i><?php echo e(__('common.edit')); ?>

                                                </button>
                                                <button
                                                    onclick="deleteItem('kelas', <?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>)"
                                                    class="text-red-600 hover:text-red-900 text-sm font-medium">
                                                    <i class="fas fa-trash mr-1"></i><?php echo e(__('common.delete')); ?>
                    ...
                    <div id="content-jurusan" class="tab-content hidden">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
                            ...
                            <button onclick="openModal('jurusan')"
                                ...
                                <i class="fas fa-plus mr-2"></i><?php echo e(__('common.add_jurusan')); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $jurusan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="px-6 py-4">
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                            ...
                                            <div class="flex space-x-2">
                                                <button
                                                    onclick="editItem('jurusan', <?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>, <?php echo e(json_encode($item->deskripsi ?? '')); ?>)"
                                                    class="text-blue-600 hover:text-blue-900 text-sm font-medium">
                                                    <i class="fas fa-edit mr-1"></i><?php echo e(__('common.edit')); ?>

                                                </button>
                                                <button
                                                    onclick="deleteItem('jurusan', <?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>)"
                                                    class="text-red-600 hover:text-red-900 text-sm font-medium">
                                                    <i class="fas fa-trash mr-1"></i><?php echo e(__('common.delete')); ?>
                    ...
                    <div id="content-ekstrakurikuler" class="tab-content hidden">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
                            ...
                            <button onclick="openModal('ekstrakurikuler')"
                                ...
                                <i class="fas fa-plus mr-2"></i><?php echo e(__('common.add_ekstrakurikuler')); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $ekstrakurikuler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="px-6 py-4">
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                            ...
                                            <div class="flex space-x-2">
                                                <button
                                                    onclick="editItem('ekstrakurikuler', <?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>, <?php echo e(json_encode($item->deskripsi ?? '')); ?>)"
                                                    class="text-blue-600 hover:text-blue-900 text-sm font-medium">
                                                    <i class="fas fa-edit mr-1"></i><?php echo e(__('common.edit')); ?>

                                                </button>
                                                <button
                                                    onclick="deleteItem('ekstrakurikuler', <?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>)"
                                                    class="text-red-600 hover:text-red-900 text-sm font-medium">
                                                    <i class="fas fa-trash mr-1"></i><?php echo e(__('common.delete')); ?>
                    ...
                    <div id="content-mata-pelajaran" class="tab-content hidden">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
                            ...
                            <button onclick="openModal('mata-pelajaran')"
                                ...
                                <i class="fas fa-plus mr-2"></i><?php echo e(__('common.add_mata_pelajaran')); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $mataPelajaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="px-6 py-4">
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                            ...
                                            <div class="flex space-x-2">
                                                <button
                                                    onclick="editItem('mata-pelajaran', <?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>, '')"
                                                    class="text-blue-600 hover:text-blue-900 text-sm font-medium">
                                                    <i class="fas fa-edit mr-1"></i><?php echo e(__('common.edit')); ?>

                                                </button>
                                                <button
                                                    onclick="deleteItem('mata-pelajaran', <?php echo e($item->id); ?>, <?php echo e(json_encode($item->nama)); ?>)"
                                                    class="text-red-600 hover:text-red-900 text-sm font-medium">
                                                    <i class="fas fa-trash mr-1"></i><?php echo e(__('common.delete')); ?>
...
<?php endif; ?>
<?php /**PATH E:\PROJEKU\telkom\resources\views\settings\data-management.blade.php ENDPATH**/ ?>